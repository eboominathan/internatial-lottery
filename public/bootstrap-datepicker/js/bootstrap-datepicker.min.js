    ...
    j.prototype = {
            ...
            if (
                ...
                a.isArray(f.daysOfWeekDisabled) ||
                    (f.daysOfWeekDisabled =
                        f.daysOfWeekDisabled.split(/[,\s]*/)),
                (f.daysOfWeekDisabled = a.map(
                    f.daysOfWeekDisabled,
                    function (a) {
        ...
        setValue: function () {
            ...
            return (
                this.isInput
                    ...
                    : this.component &&
                      this.element.find("input").val(a).change(),
                this
            );
        },
        ...
        fillDow: function () {
            ...
            if (this.o.calendarWeeks) {
                this.picker
                    .find(
                        ".datepicker-days thead tr:first-child .datepicker-switch"
                    )
                    .attr("colspan", function (a, b) {
                        return parseInt(b) + 1;
                    });
        ...
        fill: function () {
            ...
            if (!isNaN(f) && !isNaN(g)) {
                ...
                n.setUTCDate(o),
                    n.setUTCDate(
                        o - ((n.getUTCDay() - this.o.weekStart + 7) % 7)
                    );
                var r = new Date(n);
                ...
                for (var s, t = []; n.valueOf() < r; ) {
                    if (
                        ...
                        var u = new Date(
                                +n +
                                    ((this.o.weekStart - n.getUTCDay() - 7) %
                                        7) *
                                        864e5
                            ),
                            v = new Date(
                                Number(u) + ((11 - u.getUTCDay()) % 7) * 864e5
                            ),
                            w = new Date(
            ...
            parseDate: function (d, e, f) {
                ...
                if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(d)) {
                    for (d = new Date(), k = 0; k < m.length; k++)
                        switch (
                            ((h = l.exec(m[k])), (i = parseInt(h[1])), h[2])
                        ) {
                            case "d":
                                d.setUTCDate(d.getUTCDate() + i);
                                break;
                            case "m":
                                d = j.prototype.moveMonth.call(
                                    j.prototype,
                                    d,
                                    i
                                );
