...
<head>
    ...
    @font-face {
        ...
        font-style: Italic;
        font-weight: 400;
        src: url(build/fonts/DMSans-Italic.eot);
        src: local("DM Sans Italic"), local("DMSans-Italic"), url(build/fonts/DMSans-Italicd41d.eot?#iefix) format("embedded-opentype"), url(build/fonts/DMSans-Italic.woff2) format("woff2"), url(build/fonts/DMSans-Italic.woff) format("woff"), url(build/fonts/DMSans-Italic.ttf) format("truetype"), url(build/fonts/DMSans-Italic.svg#DMSans) format("svg")
    }
    ...
    @font-face {
        ...
        font-style: normal;
        font-weight: 500;
        src: url(build/fonts/DMSans-Medium.eot);
        src: local("DM Sans Medium"), local("DMSans-Medium"), url(build/fonts/DMSans-Mediumd41d.eot?#iefix) format("embedded-opentype"), url(build/fonts/DMSans-Medium.woff2) format("woff2"), url(build/fonts/DMSans-Medium.woff) format("woff"), url(build/fonts/DMSans-Medium.ttf) format("truetype"), url(build/fonts/DMSans-Medium.svg#DMSans) format("svg")
    }
    ...
    @font-face {
        ...
        font-style: italic;
        font-weight: 500;
        src: url(build/fonts/DMSans-MediumItalic.eot);
        src: local("DM Sans Medium Italic"), local("DMSans-MediumItalic"), url(build/fonts/DMSans-MediumItalicd41d.eot?#iefix) format("embedded-opentype"), url(build/fonts/DMSans-MediumItalic.woff2) format("woff2"), url(build/fonts/DMSans-MediumItalic.woff) format("woff"), url(build/fonts/DMSans-MediumItalic.ttf) format("truetype"), url(build/fonts/DMSans-MediumItalic.svg#DMSans) format("svg")
    }
    ...
    @font-face {
        ...
        font-style: normal;
        font-weight: 700;
        src: url(build/fonts/DMSans-Bold.eot);
        src: local("DM Sans Bold"), local("DMSans-Bold"), url(build/fonts/DMSans-Boldd41d.eot?#iefix) format("embedded-opentype"), url(build/fonts/DMSans-Bold.woff2) format("woff2"), url(build/fonts/DMSans-Bold.woff) format("woff"), url(build/fonts/DMSans-Bold.ttf) format("truetype"), url(build/fonts/DMSans-Bold.svg#DMSans) format("svg")
    }
    ...
    @font-face {
        ...
        font-style: italic;
        font-weight: 700;
        src: url(build/fonts/DMSans-BoldItalic.eot);
        src: local("DM Sans Bold Italic"), local("DMSans-BoldItalic"), url(build/fonts/DMSans-BoldItalicd41d.eot?#iefix) format("embedded-opentype"), url(build/fonts/DMSans-BoldItalic.woff2) format("woff2"), url(build/fonts/DMSans-BoldItalic.woff) format("woff"), url(build/fonts/DMSans-BoldItalic.ttf) format("truetype"), url(build/fonts/DMSans-BoldItalic.svg#DMSans) format("svg")
    }
...
<script type="application/ld+json">
  {
    ...
    "@type": "WebSite",
    "name": "Internatial Lottery",
    "url": "https:\/\/www.lotteryusa.com\/",
    "@id": "https:\/\/www.lotteryusa.com\/#website"
}
</script>
<script type="application/ld+json">
  {
    "@context": "https:\/\/schema.org",
    "@type": "WebPage",
    "name": "Your Lottery Home",
    "url": "https:\/\/www.lotteryusa.com\/",
    "isPartOf": "https:\/\/www.lotteryusa.com\/#website",
    "description": "Internatial Lottery has the latest lottery numbers and results for over 240 state lottery games, including Powerball and Mega Millions. Information on game rules, tools, stats, tax, odds, prizes, payouts, quick picks, and much more.",
    "relatedLink": [],
    "@id": "https:\/\/www.lotteryusa.com\/#webpage"
}
</script>
<style>
...
<main role="main" id="main">
  <br>
  <h3 align="center"> THE LATEST LOTTERY RESULTS </h3>
  <div class="o-container o-container--sm">
    <div class="o-layout">
      <div class="o-layout__col o-layout__col--12 o-layout__col--6@md">
        ...
        <article class="c-result-card c-result-card--featured c-result-card--themed" style="color: rgba(0,6,97,1);">
          ...
          <header class="c-result-card__header c-result-card__header--has-sub-title ">
            ...
            <div class="c-result-card__game-details text-left">
              <span class="c-result-card__titles">INTERNATIONAL - LOTTERY </span>

              <time class="c-result-card__sub-title" datetime="2023-01-11">
                Friday , Jan 06,2023
              </time>
          </div>
      </header>
      <div class="c-result-card__result c-result-card__result--has-extra">
            ...
            <tr>
                <td>
                    ...
                    <div class="c-result-card__result-row">
                      <ul class="c-result c-result--lg c-result-card__result-list" style="width: 200px;">
                        <li class="c-ball c-ball--default c-result__item c-ball--lg"> 20 </li>
                        <li class="c-ball c-ball--default c-result__item c-ball--lg"> 46 </li>
                        <li class="c-ball c-ball--default c-result__item c-ball--lg"> 599</li>
                        <li class="c-ball c-ball--default c-result__item c-ball--lg"> 633</li>
                    </ul>
                </div>
            </td>
            <td>
              <span style="margin: 0px 115px;"> B : JACKPOT</span>
              <div class="c-result-card__result-row">
                  <ul class="c-result c-result--lg c-result-card__result-list " style="margin: 0px 60px;width:200px">
                    <li class="c-ball c-ball--default c-result__item c-ball--lg"> 20 </li>
                    <li class="c-ball c-ball--default c-result__item c-ball--lg"> 46 </li>
                    <li class="c-ball c-ball--default c-result__item c-ball--lg"> 599</li>
                    <li class="c-ball c-ball--default c-result__item c-ball--lg"> 633</li>
        ...
        <td>
          <span style="margin: 0px 115px;"> D : JACKPOT</span>
          <div class="c-result-card__result-row">
              <ul class="c-result c-result--lg c-result-card__result-list " style="margin: 0px 60px;">
                <li class="c-ball c-ball--default c-result__item c-ball--lg"> 20 </li>
                <li class="c-ball c-ball--default c-result__item c-ball--lg"> 46 </li>
                <li class="c-ball c-ball--default c-result__item c-ball--lg"> 599</li>
                <li class="c-ball c-ball--default c-result__item c-ball--lg"> 633</li>
