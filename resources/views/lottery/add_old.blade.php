...
<head>
    ...
    <meta name="description" class="swiftype" data-type="string" content="Internatial Lottery has the latest lottery numbers and results for over 240 state lottery games, including Powerball and Mega Millions. Information on game rules, tools, stats, tax, odds, prizes, payouts, quick picks, and much more.">
    <meta name="keywords" content="us lottery results,us Lottery,us Winning Numbers,us Lotto,us Lotto Results, Lotto, Lottery, Lottery Results,Powerball,Cash 4 Life,Wild Card,Lotto">
    <style type="text/css">
      @font-face {
        font-display: swap;
        font-family: DM Sans;
        font-style: normal;
        font-weight: 400;
        src: url({{url('/')}}/build/fonts/DMSans-Regular.eot);
        src: local("DM Sans Regular"), local("DMSans-Regular"), url({{url('/')}}/build/fonts/DMSans-Regulard41d.eot?#iefix) format("embedded-opentype"), url({{url('/')}}/build/fonts/DMSans-Regular.woff2) format("woff2"), url({{url('/')}}/build/fonts/DMSans-Regular.woff) format("woff"), url({{url('/')}}/build/fonts/DMSans-Regular.ttf) format("truetype"), url({{url('/')}}/build/fonts/DMSans-Regular.svg#DMSans) format("svg")
    }
    ...
    @font-face {
        ...
        font-style: Italic;
        font-weight: 400;
        src: url({{url('/')}}/build/fonts/DMSans-Italic.eot);
        src: local("DM Sans Italic"), local("DMSans-Italic"), url({{url('/')}}/build/fonts/DMSans-Italicd41d.eot?#iefix) format("embedded-opentype"), url({{url('/')}}/build/fonts/DMSans-Italic.woff2) format("woff2"), url({{url('/')}}/build/fonts/DMSans-Italic.woff) format("woff"), url({{url('/')}}/build/fonts/DMSans-Italic.ttf) format("truetype"), url({{url('/')}}/build/fonts/DMSans-Italic.svg#DMSans) format("svg")
    }
    ...
    @font-face {
        ...
        font-style: normal;
        font-weight: 500;
        src: url({{url('/')}}/build/fonts/DMSans-Medium.eot);
        src: local("DM Sans Medium"), local("DMSans-Medium"), url({{url('/')}}/build/fonts/DMSans-Mediumd41d.eot?#iefix) format("embedded-opentype"), url({{url('/')}}/build/fonts/DMSans-Medium.woff2) format("woff2"), url({{url('/')}}/build/fonts/DMSans-Medium.woff) format("woff"), url({{url('/')}}/build/fonts/DMSans-Medium.ttf) format("truetype"), url({{url('/')}}/build/fonts/DMSans-Medium.svg#DMSans) format("svg")
    }
    ...
    @font-face {
        ...
        font-style: italic;
        font-weight: 500;
        src: url({{url('/')}}/build/fonts/DMSans-MediumItalic.eot);
        src: local("DM Sans Medium Italic"), local("DMSans-MediumItalic"), url({{url('/')}}/build/fonts/DMSans-MediumItalicd41d.eot?#iefix) format("embedded-opentype"), url({{url('/')}}/build/fonts/DMSans-MediumItalic.woff2) format("woff2"), url({{url('/')}}/build/fonts/DMSans-MediumItalic.woff) format("woff"), url({{url('/')}}/build/fonts/DMSans-MediumItalic.ttf) format("truetype"), url({{url('/')}}/build/fonts/DMSans-MediumItalic.svg#DMSans) format("svg")
    }
    ...
    @font-face {
        ...
        font-style: normal;
        font-weight: 700;
        src: url({{url('/')}}/build/fonts/DMSans-Bold.eot);
        src: local("DM Sans Bold"), local("DMSans-Bold"), url({{url('/')}}/build/fonts/DMSans-Boldd41d.eot?#iefix) format("embedded-opentype"), url({{url('/')}}/build/fonts/DMSans-Bold.woff2) format("woff2"), url({{url('/')}}/build/fonts/DMSans-Bold.woff) format("woff"), url({{url('/')}}/build/fonts/DMSans-Bold.ttf) format("truetype"), url({{url('/')}}/build/fonts/DMSans-Bold.svg#DMSans) format("svg")
    }
    ...
    @font-face {
        ...
        font-style: italic;
        font-weight: 700;
        src: url({{url('/')}}/build/fonts/DMSans-BoldItalic.eot);
        src: local("DM Sans Bold Italic"), local("DMSans-BoldItalic"), url({{url('/')}}/build/fonts/DMSans-BoldItalicd41d.eot?#iefix) format("embedded-opentype"), url({{url('/')}}/build/fonts/DMSans-BoldItalic.woff2) format("woff2"), url({{url('/')}}/build/fonts/DMSans-BoldItalic.woff) format("woff"), url({{url('/')}}/build/fonts/DMSans-BoldItalic.ttf) format("truetype"), url({{url('/')}}/build/fonts/DMSans-BoldItalic.svg#DMSans) format("svg")
    }
...
@media (min-width:73.125em) {
  ...
  .o-lusa-game-col__result-list:after {
      box-shadow: inset -1px 0 0 0 #dfdee8;
      content: "";
      display: block;
      height: 100%;
...
.o-lusa-archive-col__result-list {
    margin-bottom: 48px
}

.o-lusa-archive-col__action-link {
    padding: 24px 16px 0
}
...
.o-link-card:hover:after {
    box-shadow: inset 0 0 0 2px #0a0827, 0 2px 4px 0 #2622620d
}

.o-link-card__link:after {
    bottom: 0;
    content: "";
    left: 0;
    overflow: hidden;
...
.o-ui-list--compact .o-ui-list__item {
    margin-bottom: 8px
}
...
.o-card-group .o-card-group__item {
    border-radius: 0
}

.o-card-group__item:first-of-type {
    border-top-left-radius: 8px;
    border-top-right-radius: 8px
}

.o-card-group__item:last-of-type {
...
.o-header-actions__title {
    justify-self: center;
    margin-bottom: 0
}

.o-header-actions__controls {
    display: -ms-flexbox;
    display: flex;
    margin-left: auto
}

.o-header-actions__controls :last-child {
    margin-right: 0
}

.o-header-actions__control {
    height: 32px;
    margin-right: 4px;
    width: 32px
}

.o-header-actions__control--inactive {
    opacity: .4
}
...
.o-header-game__title {
    margin-bottom: 0
}

.o-header-game__media {
    margin-left: auto
}
...
@media (max-width:73.115em) {
    .c-global-header__user-actions {
      margin-left: auto;
      min-height: 48px
  }
}

.c-global-header__user-action {
    -ms-flex-align: center;
    -ms-flex-item-align: stretch;
    align-items: center;
    align-self: stretch;
...
@media (max-width:73.115em) {
    .c-global-header__user-login {
      background-image: url(build/images/icons/16px/dark/user.1c43bfd4.svg);
...
@media (max-width:22.49em) {
    .c-global-header__user-login-label {
      display: none
  }
}

.c-global-header__user-icon {
    -ms-flex-align: center;
    -ms-flex-pack: center;
    align-items: center;
    background: #33adb6;
...
.c-global-header .c-global-header__join-link {
    display: none
}
...
.c-global-header__menu-control {
    -ms-flex-order: 1;
    background-image: url(build/images/icons/16px/dark/hamburger.b2b1db1c.svg);
...
.c-global-header__menu-control--active {
    background-image: none
}

.c-global-header__search-control {
...
@media (max-width:73.115em) {
  ...
  .c-global-header--expanded .c-global-header__logo-link {
      height: 48px;
      left: 0;
      margin-left: 0;
      padding-left: 8px;
  ...
  .c-global-header--expanded .c-global-header__logo {
...
@media (min-width:48em) {
  ...
  .c-global-header--expanded .c-global-header__nav {
      padding-top: 56px;
      right: 56px
  }
...
@media (min-width:73.125em) {
  ...
  .c-global-header__search-control {
      box-shadow: inset 1px 0 0 0 #dfdee8, inset -1px 0 0 0 #dfdee8;
      margin-left: 0;
      padding: 16px 28px
  }
}
...
.c-global-nav__item:last-of-type .c-global-nav__link {
    box-shadow: none
}
...
.c-global-nav__sub-menu-control {
    background-color: initial;
    background-image: url(build/images/icons/16px/light/arrow-up.676cf1ae.svg);
...
.c-global-nav__sub-menu-control--expanded {
    background-image: url(build/images/icons/16px/light/arrow-down.99fe4dfb.svg)
}
...
.c-global-nav__link-block-link:hover {
    background-color: #626078;
    box-shadow: inset 4px 0 0 0 #fff;
    color: #fff
}

.c-global-nav__link-block-desc {
    color: #0a082799;
    display: none;
    font-size: 16px;
    font-size: .8888889rem;
...
@media (max-width:73.115em) {
  ...
  .c-global-nav__user-block {
      -ms-flex-pack: center;
      background-image: url(build/images/backgrounds/general-page-header.ec328463.svg);
      background-position: top 50% right -64px;
      background-size: 140%;
      box-shadow: inset 0 1px 0 0 #ffffff26, inset 0 -1px 0 0 #ffffff26;
      color: #fffc;
      -ms-flex-direction: column;
      flex-direction: column;
      font-size: 16px;
  ...
  .c-global-nav__user-action-body {
      -ms-flex-align: start;
      align-items: flex-start;
      display: -ms-flexbox;
      display: flex;
  ...
  .c-global-nav__user-info {
      max-width: 150px;
      overflow: hidden;
      text-overflow: ellipsis
  }

  .c-global-nav__sub-menu-wrapper--expanded {
      box-shadow: inset 0 4px 12px #0a082740
  }
  ...
  .c-global-nav__sub-menu .c-global-nav__item {
      padding-left: 0;
      padding-right: 0
  }
...
@media (min-width:73.125em) {
  ...
  .c-global-nav__link--active {
      ...
      box-shadow: inset 0 -2px 0 0 #0a0827, inset 1px 0 0 0 #dfdee8, inset -1px 0 0 0 #dfdee8
  }
  ...
  .c-global-nav__sub-menu-control--expanded {
      background-color: #0a08270d;
      background-image: url(build/images/icons/16px/dark/arrow-up.90162eff.svg)
  }

  .c-global-nav__sub-menu-wrapper {
      -webkit-overflow-scrolling: touch;
      background-color: #fff;
      box-shadow: 0 12px 16px 0 #0a08271a;
      display: none;
      height: auto;
      left: 0;
  ...
  .c-global-nav__sub-menu-container {
      margin-left: auto;
      margin-right: auto;
      max-width: 1218px;
      padding-left: 24px;
  ...
  .c-global-nav__link-block {
      box-shadow: inset 0 -1px 0 0 #0a08271a;
      padding: 24px 0;
      position: relative
  }

  .c-global-nav__link-block:hover {
      box-shadow: inset 0 -1px 0 0 #be1e2d
  }
  ...
  .c-global-nav__link-block-link:before {
      content: "";
      display: block;
      height: 100%;
      left: 0;
...
.c-global-footer__lusa-logo {
    display: block;
    margin-bottom: 16px
}

.c-global-footer__lusa-logo path {
    fill: #adacba
}
...
.c-global-footer__link-block-list {
    list-style-type: none;
    margin-bottom: 24px
}

.c-global-footer__link-block-list>:last-child {
    margin-bottom: 0
}
...
.c-global-footer__link-block {
    box-shadow: inset 0 -1px 0 0 #413e5b;
    display: block;
    font-size: 16px;
    font-size: .8888889rem;
    line-height: 1.5;
...
.c-global-footer__link-block:active,
.c-global-footer__link-block:focus,
.c-global-footer__link-block:hover {
    box-shadow: inset 0 -2px 0 0 #ff9e00
}

.c-global-footer__link-block:active .c-global-footer__link-block-desc,
.c-global-footer__link-block:focus .c-global-footer__link-block-desc,
.c-global-footer__link-block:hover .c-global-footer__link-block-desc {
    color: #ff9e00bf
}
...
.c-global-footer__link-block-link:active,
.c-global-footer__link-block-link:focus,
.c-global-footer__link-block-link:hover {
    color: #ff9e00
}

.c-global-footer__link-block-link:after {
    content: "";
    cursor: pointer;
    display: block;
    height: 100%;
...
.c-global-footer__link-bar--social {
    padding: 24px 0
}
...
.c-global-footer__link-bar-item {
    -ms-flex-preferred-size: 50%;
    flex-basis: 50%;
    margin-bottom: 8px;
    max-width: 50%
...
.c-global-footer__link-bar-item--social-icon {
    -ms-flex-preferred-size: auto;
    flex-basis: auto;
    margin-bottom: 0;
    margin-right: 16px;
...
.c-global-footer__link-bar-item--social-icon a {
    display: block
}

.c-global-footer__link-bar-item--social-icon svg {
    display: block;
    height: 48px;
    width: 48px
}

.c-global-footer__link-bar-item--social-icon:hover {
    filter: brightness(0) saturate(100%) invert(64%) sepia(97%) saturate(2204%) hue-rotate(359deg) brightness(102%) contrast(107%)
}
...
@media (min-width:48em) {
  ...
  .c-global-footer__link-bar-item:last-of-type {
      margin-right: 0
  }
}

@media (min-width:48em) and (min-width:48em) {
    .c-global-footer__link-bar-item--last-text {
      -ms-flex: auto;
      flex: auto
  }
}

.c-global-footer__link-bar-icon {
    display: block
}
...
.c-global-footer__link-bar-link:active,
.c-global-footer__link-bar-link:focus,
.c-global-footer__link-bar-link:hover {
    color: #ff9e00
}
...
.c-global-footer__badges__item {
    margin-right: 16px
}

.c-global-footer__badges__item img {
    display: block
}

.c-global-footer__badges__item--wide svg {
    max-width: 90px
}
...
.c-global-footer__badges>:last-child {
    margin-right: 0
}

.c-global-footer__lusa-seal {
    -ms-flex-align: center;
    align-items: center;
    box-shadow: inset 0 1px 0 0 #413e5b;
    display: -ms-flexbox;
...
.c-global-footer__lusa-seal-badge {
    margin-right: 16px
}

.c-global-footer__lusa-seal-badge svg {
    display: block;
    height: 64px;
    width: 64px
}
...
.c-btn--content-link-active,
.c-btn--content-link:focus,
.c-btn--content-link:hover {
...
.c-btn--arrow-link:focus,
.c-btn--arrow-link:hover {
    box-shadow: 0 2px 4px 0 #0a082740, inset 0 0 0 2px #0a0827
}
...
.c-jackpot-card__prize-label:before {
    background-image: url('{{asset("dollar.42d1b55f.svg")}}');
...
.c-upcoming-jackpot-card__state {
    font-weight: 300
}

.c-upcoming-jackpot-card__date {
    -ms-flex-order: -1;
    font-size: 14px;
    font-size: .7777778rem;
    font-weight: 500;
...
.c-upcoming-jackpot-card__logo {
    height: 48px;
    pointer-events: none;
    width: 48px
}

.c-upcoming-jackpot-card__dow {
    font-weight: 700
}

.c-upcoming-jackpot-card__header-media {
    margin-bottom: 0;
    margin-left: auto;
    margin-right: 12px
}

.c-upcoming-jackpot-card__prize-details {
    -ms-flex-item-align: center;
...
.c-upcoming-jackpot-card__prize-label {
    font-size: 16px;
    font-size: .8888889rem;
    font-weight: 500;
    line-height: 1.5;
...
.c-upcoming-jackpot-card__prize-label:before {
    background-image: url('{{asset("dollar.42d1b55f.svg")}}');
    background-position: 50% 50%;
    background-size: 24px 24px;
    content: "";
...
.c-upcoming-jackpot-card__prize-value {
    display: block;
    font-size: 21px;
    font-size: 1.1666667rem;
    font-weight: 700;
...
.c-upcoming-jackpot-card--countdown .c-upcoming-jackpot-card__date {
    font-size: 21px;
    font-size: 1.1666667rem;
    font-weight: 400;
    line-height: 1.3333333
...
.c-upcoming-jackpot-card--countdown .c-upcoming-jackpot-card__label {
    left: 16px;
    position: absolute;
    top: -12px;
    z-index: 2
...
.c-upcoming-jackpot-card--countdown .c-upcoming-jackpot-card__body {
    padding-top: 8px
}

.c-upcoming-jackpot-card__cta {
    padding: 8px 0 16px
}
...
.c-page-header:before {
    ...
    background-image: linear-gradient(180deg, #0000 40%, #000c);
    z-index: -1
}
...
.c-page-header--multistate {
    display: -ms-flexbox;
    display: flex
}

.c-page-header--multistate .c-page-header__container {
    -ms-flex-align: center;
    align-items: center;
    display: -ms-flexbox;
    display: flex;
...
.c-page-header--multistate .c-page-header__title-container {
...
.c-page-header--multistate:after {
    background-image: url(build/images/state-images/us-flag-sm.d993b9c6.jpg)
}

@media (min-width:48em) {
    .c-page-header--multistate:after {
      background-image: url(build/images/state-images/us-flag.1c99d01c.jpg)
  }
}

.c-page-header--al:after {
    background-image: url(build/images/state-images/al-sm.17d0f6fb.jpg)
}

@media (min-width:48em) {
    .c-page-header--al:after {
      background-image: url(build/images/state-images/al.8d654316.jpg)
  }
}

.c-page-header--az:after {
    background-image: url(build/images/state-images/az-sm.703a390f.jpg)
}

@media (min-width:48em) {
    .c-page-header--az:after {
      background-image: url(build/images/state-images/az.d58ab460.jpg)
  }
}

.c-page-header--ar:after {
    background-image: url(build/images/state-images/ar-sm.aadacc92.jpg)
}

@media (min-width:48em) {
    .c-page-header--ar:after {
      background-image: url(build/images/state-images/ar.7271609b.jpg)
  }
}

.c-page-header--ca:after {
    background-image: url(build/images/state-images/ca-sm.dc302b94.jpg)
}

@media (min-width:48em) {
    .c-page-header--ca:after {
      background-image: url(build/images/state-images/ca.c0f6674a.jpg)
  }
}

.c-page-header--co:after {
    background-image: url(build/images/state-images/co-sm.7e015bb3.jpg)
}

@media (min-width:48em) {
    .c-page-header--co:after {
      background-image: url(build/images/state-images/co.9ced9947.jpg)
  }
}

.c-page-header--ct:after {
    background-image: url(build/images/state-images/ct-sm.6132ca27.jpg)
}

@media (min-width:48em) {
    .c-page-header--ct:after {
      background-image: url(build/images/state-images/ct.792e99f8.jpg)
  }
}

.c-page-header--de:after {
    background-image: url(build/images/state-images/de-sm.555b34e9.jpg)
}

@media (min-width:48em) {
    .c-page-header--de:after {
      background-image: url(build/images/state-images/de.ad7fef5c.jpg)
  }
}

.c-page-header--dc:after {
    background-image: url(build/images/state-images/dc-sm.7595ab56.jpg)
}

@media (min-width:48em) {
    .c-page-header--dc:after {
      background-image: url(build/images/state-images/dc.8df1cbd4.jpg)
  }
}

.c-page-header--fl:after {
    background-image: url(build/images/state-images/fl-sm.87e1e075.jpg)
}

@media (min-width:48em) {
    .c-page-header--fl:after {
      background-image: url(build/images/state-images/fl.a391aced.jpg)
  }
}

.c-page-header--ga:after {
    background-image: url(build/images/state-images/ga-sm.95954c88.jpg)
}

@media (min-width:48em) {
    .c-page-header--ga:after {
      background-image: url(build/images/state-images/ga.f341e3c0.jpg)
  }
}

.c-page-header--id:after {
    background-image: url(build/images/state-images/id-sm.05f3a91e.jpg)
}

@media (min-width:48em) {
    .c-page-header--id:after {
      background-image: url(build/images/state-images/id.1cf3d9bc.jpg)
  }
}

.c-page-header--il:after {
    background-image: url(build/images/state-images/il-sm.923d553d.jpg)
}

@media (min-width:48em) {
    .c-page-header--il:after {
      background-image: url(build/images/state-images/il.2f207a4b.jpg)
  }
}

.c-page-header--in:after {
    background-image: url(build/images/state-images/in-sm.02ed5216.jpg)
}

@media (min-width:48em) {
    .c-page-header--in:after {
      background-image: url(build/images/state-images/in.27a5af62.jpg)
  }
}

.c-page-header--ia:after {
    background-image: url(build/images/state-images/ia-sm.22934960.jpg)
}

@media (min-width:48em) {
    .c-page-header--ia:after {
      background-image: url(build/images/state-images/ia.f5b31e3a.jpg)
  }
}

.c-page-header--ks:after {
    background-image: url(build/images/state-images/ks-sm.54da3588.jpg)
}

@media (min-width:48em) {
    .c-page-header--ks:after {
      background-image: url(build/images/state-images/ks.1f68628d.jpg)
  }
}

.c-page-header--ky:after {
    background-image: url(build/images/state-images/ky-sm.928f77c4.jpg)
}

@media (min-width:48em) {
    .c-page-header--ky:after {
      background-image: url(build/images/state-images/ky.356e8613.jpg)
  }
}

.c-page-header--la:after {
    background-image: url(build/images/state-images/la-sm.6673443c.jpg)
}

@media (min-width:48em) {
    .c-page-header--la:after {
      background-image: url(build/images/state-images/la.98a2b0dc.jpg)
  }
}

.c-page-header--me:after {
    background-image: url(build/images/state-images/me-sm.789ae3c2.jpg)
}

@media (min-width:48em) {
    .c-page-header--me:after {
      background-image: url(build/images/state-images/me.2093aad2.jpg)
  }
}

.c-page-header--md:after {
    background-image: url(build/images/state-images/md-sm.72ef3702.jpg)
}

@media (min-width:48em) {
    .c-page-header--md:after {
      background-image: url(build/images/state-images/md.9befc8e2.jpg)
  }
}

.c-page-header--ma:after {
    background-image: url(build/images/state-images/ma-sm.fbf9e05d.jpg)
}

@media (min-width:48em) {
    .c-page-header--ma:after {
      background-image: url(build/images/state-images/ma.43ddf187.jpg)
  }
}

.c-page-header--mi:after {
    background-image: url(build/images/state-images/mi-sm.f2c71a7a.jpg)
}

@media (min-width:48em) {
    .c-page-header--mi:after {
      background-image: url(build/images/state-images/mi.3adb0e29.jpg)
  }
}

.c-page-header--mn:after {
    background-image: url(build/images/state-images/mn-sm.4a521343.jpg)
}

@media (min-width:48em) {
    .c-page-header--mn:after {
      background-image: url(build/images/state-images/mn.84f2c604.jpg)
  }
}

.c-page-header--mo:after {
    background-image: url(build/images/state-images/mo-sm.f9994728.jpg)
}

@media (min-width:48em) {
    .c-page-header--mo:after {
      background-image: url(build/images/state-images/mo.8ac10c9b.jpg)
  }
}

.c-page-header--ms:after {
    background-image: url(build/images/state-images/ms-sm.7b67f21a.jpg)
}

@media (min-width:48em) {
    .c-page-header--ms:after {
      background-image: url(build/images/state-images/ms.d31a4f21.jpg)
  }
}

.c-page-header--mt:after {
    background-image: url(build/images/state-images/mt-sm.a8f7d4cf.jpg)
}

@media (min-width:48em) {
    .c-page-header--mt:after {
      background-image: url(build/images/state-images/mt.e7ff0887.jpg)
  }
}

.c-page-header--ne:after {
    background-image: url(build/images/state-images/ne-sm.40cb5a05.jpg)
}

@media (min-width:48em) {
    .c-page-header--ne:after {
      background-image: url(build/images/state-images/ne.454760f2.jpg)
  }
}

.c-page-header--nh:after {
    background-image: url(build/images/state-images/nh-sm.38367b78.jpg)
}

@media (min-width:48em) {
    .c-page-header--nh:after {
      background-image: url(build/images/state-images/nh.6cb764f5.jpg)
  }
}

.c-page-header--nj:after {
    background-image: url(build/images/state-images/nj-sm.c88f973c.jpg)
}

@media (min-width:48em) {
    .c-page-header--nj:after {
      background-image: url(build/images/state-images/nj.9a2ccd2f.jpg)
  }
}

.c-page-header--nm:after {
    background-image: url(build/images/state-images/nm-sm.440856d2.jpg)
}

@media (min-width:48em) {
    .c-page-header--nm:after {
      background-image: url(build/images/state-images/nm.3f9b3fd7.jpg)
  }
}

.c-page-header--ny:after {
    background-image: url(build/images/state-images/ny-sm.b9339eb8.jpg)
}

@media (min-width:48em) {
    .c-page-header--ny:after {
      background-image: url(build/images/state-images/ny.b1944fd1.jpg)
  }
}

.c-page-header--nc:after {
    background-image: url(build/images/state-images/nc-sm.85575e78.jpg)
}

@media (min-width:48em) {
    .c-page-header--nc:after {
      background-image: url(build/images/state-images/nc.02ff9e14.jpg)
  }
}

.c-page-header--nd:after {
    background-image: url(build/images/state-images/nd-sm.3e6823f0.jpg)
}

@media (min-width:48em) {
    .c-page-header--nd:after {
      background-image: url(build/images/state-images/nd.af9f2a77.jpg)
  }
}

.c-page-header--oh:after {
    background-image: url(build/images/state-images/oh-sm.e74c0c0d.jpg)
}

@media (min-width:48em) {
    .c-page-header--oh:after {
      background-image: url(build/images/state-images/oh.d278509a.jpg)
  }
}

.c-page-header--ok:after {
    background-image: url(build/images/state-images/ok-sm.eacbf617.jpg)
}

@media (min-width:48em) {
    .c-page-header--ok:after {
      background-image: url(build/images/state-images/ok.59bbcadd.jpg)
  }
}

.c-page-header--or:after {
    background-image: url(build/images/state-images/or-sm.d3619dbe.jpg)
}

@media (min-width:48em) {
    .c-page-header--or:after {
      background-image: url(build/images/state-images/or.967e1f3a.jpg)
  }
}

.c-page-header--pa:after {
    background-image: url(build/images/state-images/pa-sm.788b23cd.jpg)
}

@media (min-width:48em) {
    .c-page-header--pa:after {
      background-image: url(build/images/state-images/pa.600d7a2d.jpg)
  }
}

.c-page-header--pr:after {
    background-image: url(build/images/state-images/pr-sm.ce1b4198.jpg)
}

@media (min-width:48em) {
    .c-page-header--pr:after {
      background-image: url(build/images/state-images/pr.29d35f7c.jpg)
  }
}

.c-page-header--ri:after {
    background-image: url(build/images/state-images/ri-sm.459a0736.jpg)
}

@media (min-width:48em) {
    .c-page-header--ri:after {
      background-image: url(build/images/state-images/ri.022a3667.jpg)
  }
}

.c-page-header--sc:after {
    background-image: url(build/images/state-images/sc-sm.d491c66d.jpg)
}

@media (min-width:48em) {
    .c-page-header--sc:after {
      background-image: url(build/images/state-images/sc.c34dea79.jpg)
  }
}

.c-page-header--sd:after {
    background-image: url(build/images/state-images/sd-sm.c59f1500.jpg)
}

@media (min-width:48em) {
    .c-page-header--sd:after {
      background-image: url(build/images/state-images/sd.d79cf026.jpg)
  }
}

.c-page-header--tn:after {
    background-image: url(build/images/state-images/tn-sm.8e12c0b4.jpg)
}

@media (min-width:48em) {
    .c-page-header--tn:after {
      background-image: url(build/images/state-images/tn.845e8ab5.jpg)
  }
}

.c-page-header--tx:after {
    background-image: url(build/images/state-images/tx-sm.fdb072e4.jpg)
}

@media (min-width:48em) {
    .c-page-header--tx:after {
      background-image: url(build/images/state-images/tx.0c47b7be.jpg)
  }
}

.c-page-header--vt:after {
    background-image: url(build/images/state-images/vt-sm.4ad250d3.jpg)
}

@media (min-width:48em) {
    .c-page-header--vt:after {
      background-image: url(build/images/state-images/vt.26a9c9c5.jpg)
  }
}

.c-page-header--va:after {
    background-image: url(build/images/state-images/va-sm.4971e0e0.jpg)
}

@media (min-width:48em) {
    .c-page-header--va:after {
      background-image: url(build/images/state-images/va.930c90e5.jpg)
  }
}

.c-page-header--wa:after {
    background-image: url(build/images/state-images/wa-sm.547ae1de.jpg)
}

@media (min-width:48em) {
    .c-page-header--wa:after {
      background-image: url(build/images/state-images/wa.40121274.jpg)
  }
}

.c-page-header--wv:after {
    background-image: url(build/images/state-images/wv-sm.734141b0.jpg)
}

@media (min-width:48em) {
    .c-page-header--wv:after {
      background-image: url(build/images/state-images/wv.592d7eb4.jpg)
  }
}

.c-page-header--wi:after {
    background-image: url(build/images/state-images/wi-sm.e8a61180.jpg)
}

@media (min-width:48em) {
    .c-page-header--wi:after {
      background-image: url(build/images/state-images/wi.c02dd178.jpg)
  }
}

.c-page-header--wy:after {
    background-image: url(build/images/state-images/wy-sm.c9afdcb6.jpg)
}

@media (min-width:48em) {
    .c-page-header--wy:after {
      background-image: url(build/images/state-images/wy.0c483a2c.jpg)
  }
...
.c-general-page-header {
    background-color: #0a0827;
    background-image: url(build/images/backgrounds/general-page-header.ec328463.svg);
    background-position: bottom 54% right -120px;
    background-repeat: no-repeat;
    background-size: 143%;
    color: #fff;
    margin-bottom: 32px;
...
.c-general-page-header--roomy {
    padding: 24px 0
}

.c-general-page-header--narrow .c-general-page-header__container {
    max-width: 820px
}

.c-general-page-header--medium .c-general-page-header__container {
    max-width: 1018px
}
...
.c-general-page-header__container {
    -ms-flex-pack: center;
...
.c-general-page-header__breadcrumbs {
    display: none
}

.c-general-page-header__title {
    font-size: 28px;
...
@media (min-width:48em) {
    .c-general-page-header {
      background-position: bottom 31% right -230px, 50%;
...
@media (min-width:73.125em) {
    .c-general-page-header {
      background-position: bottom 30% right -170px, 50%;
  ...
  .c-general-page-header--roomy .c-general-page-header__title {
      font-size: 42px;
      font-size: 2.3333333rem;
...
.c-region-menu {
    background-color: #fff;
    border-bottom: 1px solid #dfdee8;
    box-shadow: 0 4px 2px 0 rgba(0, 0, 0, .025);
    pointer-events: auto
}

@media (min-width:48em) {
    .c-region-menu__container {
      margin-left: auto;
      margin-right: auto;
      max-width: 1218px;
      padding-left: 16px;
...
.c-region-menu__menu .c-carousel {
    width: 100%
}

.c-region-menu__menu .c-carousel__item:last-child {
...
.c-region-menu__menu-item:last-of-type {
    margin-right: 0
}

.c-region-menu__menu-link {
    color: #0a0827;
    display: -ms-flexbox;
    display: flex;
    -ms-flex: auto;
...
.c-region-menu__menu-link--active,
.c-region-menu__menu-link:active,
.c-region-menu__menu-link:focus,
.c-region-menu__menu-link:hover {
    text-decoration: underline;
...
@media (min-width:48em) {
  ...
  .c-breadcrumbs__link:after {
      background-image: url(build/images/icons/12px/light/arrow-right.d0f44a66.svg);
...
.c-navbar__items .c-carousel__item {
    padding-right: 8px !important
}

.c-navbar__items .c-carousel__item:first-child {
    padding-left: 8px
}
...
.c-navbar__button:active,
.c-navbar__button:focus,
.c-navbar__button:hover,
.c-navbar__link:active,
.c-navbar__link:focus,
.c-navbar__link:hover {
    box-shadow: inset 0 0 0 1px #0a082766
}
...
.c-navbar__button--active:active,
.c-navbar__button--active:focus,
.c-navbar__button--active:hover,
.c-navbar__link--active:active,
.c-navbar__link--active:focus,
.c-navbar__link--active:hover {
    background-color: #0a0827cc
}
...
.c-navbar__submenu-item:last-child .c-navbar__submenu-link {
    border-bottom: none
}

.c-navbar__submenu-link:hover {
    background: #f4f4f7;
    text-decoration: underline
}
...
.c-filter-bar__item--sort {
    min-width: 145px
}

.c-filter-bar__item--sort .c-dropdown__target {
    min-width: 200px
}

.c-filter-bar__item--export {
    -ms-flex: 0 1 auto;
    flex: 0 1 auto;
    margin-left: auto;
    margin-right: 0
...
.c-filter-bar__item--days,
.c-filter-bar__item--draw,
.c-filter-bar__item--range {
    display: none
}
...
.c-filter-bar__export-btn {
    height: 40px;
    margin-right: 0;
    width: 40px
}

.c-filter-bar__export-btn span {
    display: none
}
...
@media (min-width:48em) {
  ...
  .c-filter-bar__item--sort .c-filter-bar__input {
      width: 100%
  }
...
.c-results-table__items {
    display: block;
    margin: 0;
    width: 100%
}

.c-results-table__promo-item {
    display: block;
    margin-bottom: 24px;
    width: 100%
}

.c-results-table__promo-item td {
    display: block;
    padding: 0
}

.c-results-table__item-header {
...
.c-results-table__item-header td,
.c-results-table__item-header th {
    display: block;
    padding: 0;
    text-align: center
}
...
.c-ball--white {
    ...
    align-items: center;
    background: #fcfcff;
    background-image: linear-gradient(180deg, #f4f4f7b3, #dfdee8b3);
...
.c-ball--extra.c-ball--empty,
.c-ball--red.c-ball--empty {
    border-color: #be1e2d
}
...
.c-ball--green {
    ...
    background-image: radial-gradient(circle at top, #ffffff26 30%, #fff0 75%);
    box-shadow: inset 0 0 0 1px #68c554;
    color: #0a0827
}

.c-ball--green.c-ball--empty {
    border-color: #68c554
}
...
.c-ball--fire {
    ...
    background-image: radial-gradient(circle at top, #ffffff26 30%, #fff0 75%);
    box-shadow: inset 0 0 0 1px #f20;
    color: #fff
}

.c-ball--fire.c-ball--empty {
    border-color: #f20
}
...
.c-ball--purple {
    ...
    background-image: radial-gradient(circle at top, #ffffff26 30%, #fff0 75%);
    box-shadow: inset 0 0 0 1px #93498f;
    color: #fff
}

.c-ball--purple.c-ball--empty {
    border-color: #93498f
}
...
.c-ball--blue.c-ball--empty {
    border-color: #326eb1
}

.c-ball--aqua {
    background-color: #0a6b7d;
    background-image: radial-gradient(circle at top, #ffffff26 30%, #fff0 75%);
    box-shadow: inset 0 0 0 1px #0a6b7d;
    color: #fff
}

.c-ball--aqua.c-ball--empty {
    border-color: #0a6b7d
}
...
.c-ball--pink {
    ...
    background-image: radial-gradient(circle at top, #ffffff26 30%, #fff0 75%);
    box-shadow: inset 0 0 0 1px #cf517a;
    color: #fff
}

.c-ball--pink.c-ball--empty {
    border-color: #cf517a
}
...
.c-content-card {
    background-color: #fff;
    border-radius: 8px;
    box-shadow: inset 0 0 0 4px #dfdee8, 6px 6px 0 0 #dfdee8;
    margin-bottom: 6px;
    padding: 16px;
    position: relative;
    width: calc(100% - 6px)
...
.c-content-link-card:hover .c-content-link-card__body {
    border: 4px solid #dfdee8
}

.c-content-link-card__body {
    background-color: #fff;
    border: 4px solid #dfdee899;
    border-radius: 12px;
    margin: 0 6px 0 0;
    padding: 20px 48px 20px 20px
}

.c-content-link-card__body>:last-child {
    margin-bottom: 0
}

.c-content-link-card__body:after {
    background-image: url(build/images/icons/16px/dark/arrow-right.adad23de.svg);
    background-position: 50%;
    background-repeat: no-repeat;
    color: #0a0827;
...
.c-content-link-card__link:after {
    bottom: 0;
    content: "";
    left: 0;
    overflow: hidden;
...
.c-explore-card,
.c-explore-card--themed {
    background-image: linear-gradient(180deg, #fffc 0, #fff 120px)
}

@media (max-width:47.99em) {
    .c-explore-card--outlined-sm {
      border: 1px solid #0a0827
  }
}

.c-explore-card__header {
    -ms-flex-align: center;
    align-items: center;
    display: -ms-flexbox;
    display: flex;
...
.c-explore-card__media {
    margin-right: 24px;
    width: 104px
}

.c-explore-card__body {
    -ms-flex-pack: justify;
    display: -ms-flexbox;
    display: flex;
    -ms-flex: 1;
...
.c-explore-card__body--has-media {
    padding: 16px 24px
}

.c-explore-card__title {
    color: #0a0827;
    font-size: 26px;
    font-size: 1.4444444rem;
    line-height: 1.2307692;
...
.c-explore-card--daily .c-explore-card__title {
    font-size: 21px;
    font-size: 1.1666667rem;
    line-height: 1.1428571
}
...
.c-explore-card__cta-icon {
    margin-left: auto
}

.c-explore-card--reverse .c-explore-card__body {
    -ms-flex-align: center;
    align-items: center;
    -ms-flex-direction: row-reverse;
    flex-direction: row-reverse
...
.c-explore-card--reverse .c-explore-card__media {
    margin-left: 24px;
    margin-right: 0
}

.c-explore-card--center .c-explore-card__header {
    -ms-flex-direction: column;
    flex-direction: column;
    text-align: center
}

.c-explore-card--center .c-explore-card__media {
    margin: 0 auto 16px
}

.c-explore-card--center .c-explore-card__footer {
    -ms-flex-pack: center;
    justify-content: center;
    text-align: center
}

.c-explore-card--center .c-explore-card__cta-icon {
    margin-left: 4px
}

.c-explore-card:hover {
    box-shadow: 0 2px 8px 0 #2622621a
}

.c-explore-card:hover .c-explore-card__footer {
    background-color: #f4f4f7;
    border-bottom-left-radius: 8px;
    border-bottom-right-radius: 8px
}
...
@media (max-width:47.99em) {
    .c-explore-card-list--outlined-sm {
      border: 1px solid #0a0827
  }
}

.c-explore-card-list__header {
    display: -ms-flexbox;
    display: flex;
    -ms-flex-direction: column;
    flex-direction: column;
...
.c-explore-card-list__header-body {
    -ms-flex-pack: justify;
    -ms-flex-align: center;
    align-items: center;
    display: -ms-flexbox;
...
.c-explore-card-list__header-body--has-media {
    padding: 16px 24px
}

.c-explore-card-list__title {
    color: #0a0827;
    font-size: 26px;
    font-size: 1.4444444rem;
    line-height: 1.2307692;
...
.c-explore-card-list--daily .c-explore-card-list__title {
    font-size: 21px;
    font-size: 1.1666667rem;
    line-height: 1.1428571
}

.c-explore-card-list__sub {
    color: #0a082799;
    font-size: 16px;
    font-size: .8888889rem;
    line-height: 1.5;
...
.c-explore-card-list__media {
    margin-left: 24px;
    margin-right: 0;
    width: 104px
}

.c-explore-card-list__list {
    list-style-type: none;
    margin: 0
}

.c-explore-card-list__list-item:hover {
    background-color: #f4f4f7;
    box-shadow: 0 -1px 0 #dfdee8, inset 0 -1px 0 #dfdee8;
    cursor: pointer;
    text-decoration: underline;
    text-decoration-thickness: 1px;
    text-underline-offset: 6px
...
.c-explore-card-list__list-item:first-of-type:hover {
    box-shadow: inset 0 -1px 0 #dfdee8
}

.c-explore-card-list__list-item--active .c-explore-card-list__list-item-link {
    font-weight: 700;
    text-decoration: underline;
    text-decoration-thickness: 1px;
    text-underline-offset: 6px
...
.c-explore-card-list__list-item:last-of-type:hover {
    border-bottom-left-radius: 8px;
    border-bottom-right-radius: 8px;
    box-shadow: 0 -1px 0 #dfdee8
}

.c-explore-card-list__list-item:last-of-type .c-explore-card-list__list-item-link {
    box-shadow: none
}

.c-explore-card-list__list-item-link {
    -ms-flex-align: center;
    align-items: center;
    box-shadow: inset 0 -1px 0 0 #dfdee8;
    font-weight: 400;
...
.c-explore-card-list__list-item-link,
.c-explore-card-list__list-item-link--btn {
    color: #0a0827;
    display: -ms-flexbox;
    display: flex;
    font-size: 16px;
...
.c-explore-card-list__list-item-link--btn span {
    margin-left: 24px
}

.c-explore-card-list__list-item-icon {
    display: -ms-flexbox;
    display: flex;
    margin-right: 8px
}

.c-explore-card-list__cta-icon {
    margin-left: auto;
    margin-right: 24px
}
...
.c-claim-center-card__img img {
    display: block;
    height: auto;
    width: 100%
}

.c-claim-center-card__body {
    color: #0a082799;
    display: -ms-flexbox;
    display: flex;
    -ms-flex-direction: column;
...
.c-claim-center-card__body>:last-child {
    margin-bottom: 0
}

.c-claim-center-card__addr {
    font-style: normal;
    margin-bottom: 0
}

.c-claim-center-card__content-row {
    margin-bottom: 12px
}

.c-claim-center-card__content-row>:last-child {
    margin-bottom: 0
}

.c-claim-center-card__content-row--pin-bottom {
    margin-top: auto
}

.c-claim-center-card__title {
    color: #0a0827;
    font-size: 18px;
    font-size: 1rem;
    font-weight: 700;
...
.c-claim-center-card__link--tel {
    display: block;
    margin-bottom: 4px
}

.c-claim-center-card__link--tel:last-of-type {
    margin-bottom: 0
}
...
.c-countdown--block .c-countdown__item {
    -ms-flex-pack: center;
    background-color: #fff;
    border-radius: 4px;
    color: #0a0827;
...
.c-countdown--block .c-countdown__item:last-of-type {
    margin-right: 0
}

.c-countdown--block .c-countdown__item-text {
    display: block;
    left: 0;
    position: absolute;
    width: 100%
...
.c-countdown--block .c-countdown__time {
    font-size: 18px;
    font-size: 1rem;
    font-weight: 700;
    line-height: 1.3333333
...
.c-countdown--block .c-countdown__label {
    font-size: 16px;
    font-size: .8888889rem;
    font-weight: 500;
    line-height: 1.5
...
.c-countdown--block .c-countdown__separator {
...
.c-standard-card--flush {
    padding-left: 0;
    padding-right: 0
}

.c-standard-card--flush .c-standard-card__title {
    padding-left: 16px;
    padding-right: 16px
}

.c-standard-card--muted {
    background-color: #0a08270d
}
...
.c-link-block-group__items,
.c-link-block-group__items .c-link-block-group__item:last-child {
    border-bottom-left-radius: 8px;
    border-bottom-right-radius: 8px
}

.c-link-block,
.c-link-block-group__item {
    background-color: #fff
}
...
.c-accordion-group--flow {
    margin-bottom: 48px
}

.c-accordion-group__controls {
    position: absolute;
    right: 0;
    top: -48px
}
...
.c-accordion-group__controls .c-btn {
    padding: 8px 0;
    text-align: right;
    width: 110px
}
...
.c-accordion-group__item--first {
    border-top: 1px solid #dfdee8;
    border-top-left-radius: 8px;
    border-top-right-radius: 8px
}

.c-accordion-group__item:last-of-type {
    border-bottom: 1px solid #dfdee8;
    border-bottom-left-radius: 8px;
    border-bottom-right-radius: 8px;
    box-shadow: none
...
.c-accordion-group__control:active,
.c-accordion-group__control:focus {
    outline: none
}

.c-accordion-group__icon {
    margin-right: 8px;
    min-width: 32px;
    pointer-events: none
}

.c-accordion-group__panel {
    color: #0a0827cc;
    font-size: 18px;
    font-size: 1rem;
    line-height: 1.5555556;
...
.c-accordion-group__panel-content {
    padding-bottom: 8px
}

.c-accordion-group__panel-content>:last-child {
    margin-bottom: 0
}
...
.c-timeline__title {
    ...
    border-right: 4px solid #dfdee8;
    border-top: 4px solid #dfdee8;
    border-top-left-radius: 8px;
    border-top-right-radius: 8px;
    box-shadow: 6px 6px 0 0 #dfdee8;
    font-size: 18px;
...
.c-timeline__title:before {
    background-color: #fff;
    border-radius: 12px;
    box-shadow: inset 0 0 0 4px #dfdee8;
    content: "";
    display: block;
    height: 24px;
    position: absolute;
...
.c-timeline__title:first-of-type:before {
    content: none
}
...
.c-timeline__title--active {
    ...
    box-shadow: 6px 6px 0 0 #262262;
    color: #262262
}

.c-timeline__title--active:before {
    background-color: #262262;
    box-shadow: none
}
...
.c-timeline__content--last {
    border-bottom: 4px solid #dfdee8;
    border-bottom-left-radius: 8px;
    border-bottom-right-radius: 8px;
    margin: 0 0 24px
}

.c-timeline__content--last:after {
    background-color: #dfdee8;
    bottom: -24px;
    content: "";
    display: block;
...
.c-timeline__content--active.c-timeline__content--last {
    border-bottom: 4px solid #262262
}

.c-timeline__content:last-of-type {
    margin-bottom: 0
}

.c-timeline__content:last-of-type:after {
    content: none
}
...
.c-table thead tr:first-of-type th:first-child {
    border-top-left-radius: 8px
}

.c-table thead tr:first-of-type th:last-child {
    border-top-right-radius: 8px
}
...
@media (max-width:47.99em) {
    ...
    .c-table--fixed-col tbody td:first-child,
    .c-table--fixed-col thead th:first-child {
      box-shadow: 4px 0 8px 0 #0a08271a;
      left: 0;
      position: -webkit-sticky;
      position: sticky;
      z-index: 1
...
.c-table--zebra tbody tr:nth-child(2n),
.c-table__group,
.c-table__group td {
    background-color: #f4f4f740
}

.c-table .c-table__nested-row td:first-child {
    border-left: 0
}
...
.c-table :last-child>:last-child>td:first-child {
    border-bottom-left-radius: 8px
}

.c-table :last-child>:last-child>td:last-child {
    border-bottom-right-radius: 8px
}

.c-table--nested tbody .c-table__grouped,
.c-table--nested tbody .c-table__grouped:first-child {
    border-left: 0
}

.c-table--nested :last-child>:last-child>td:first-child {
    border-bottom-left-radius: 0
}

.c-table--nested .c-table__faux-bl {
    border-bottom-left-radius: 8px
}

.c-table__bg {
    background-color: #f4f4f780
}
...
.c-table__split-cell :first-child {
    display: block;
    -ms-flex: 1;
    flex: 1
}

.c-table__split-cell :last-child {
    -ms-flex: 3;
    flex: 3
}

.c-table tr .c-table__no-bl:first-child,
tr .c-table__no-bl .c-table__no-bl:first-child {
    border-left: none
}
...
.c-notice__col:last-child>:last-child {
    margin-bottom: 0
}
...
.c-scene__content p:first-of-type {
    font-weight: 500
}

.c-scene__content p:last-of-type {
    margin-bottom: 0
}
...
.c-message--floating .c-message__content {
    display: inline-block
}
...
.c-list-block__item:first-child {
    border-top: 0;
    padding-top: 0
}

.c-list-block__item>:last-child {
    margin-bottom: 0
}

.c-list-block__item:last-of-type {
    border-bottom: none
}

.c-list-block__item-title {
    font-weight: 500;
    margin-bottom: 0
}

.c-list-block__item-desc,
.c-list-block__item-title {
    font-size: 16px;
    font-size: .8888889rem;
    line-height: 1.5
...
@media (min-width:73.125em) {
    .c-table .c-list-block {
      display: -ms-flexbox;
      display: flex
  }

  .c-table .c-list-block .c-list-block__item {
      border-top: 0;
      -ms-flex: 1;
      flex: 1;
      padding: 0
  ...
  .c-table--2 .c-list-block .c-list-block__item {
      display: -ms-flexbox;
      display: flex;
      padding-bottom: 0
  }

  .c-table--2 .c-list-block .c-list-block__item-title {
      margin-right: 16px;
      min-width: 72px
  }
}
...
.c-well {
    ...
    border: 4px solid #dfdee8;
    border-radius: 12px;
    box-shadow: 0 -4px 0 0 #dfdee8, 0 8px 0 0 #dfdee8
}
...
.c-prediction-card>:last-child {
    margin-bottom: 0
}

.c-prediction-card__balls {
    margin-bottom: 8px
}

.c-prediction-card__title {
    font-size: 18px;
    font-size: 1rem;
    line-height: 1.3333333;
    margin-bottom: 0
...
.c-quick-pick-card>:last-child {
    margin-bottom: 0
}

.c-quick-pick-card__header {
    -ms-flex-align: center;
    align-items: center;
    display: -ms-flexbox;
    display: flex;
...
.c-quick-pick-card__logo {
    height: 48px;
    margin-right: 12px;
    width: 48px
}

.c-quick-pick-card__inputs {
    display: -ms-flexbox;
    display: flex;
    margin-bottom: 16px;
    width: 100%
...
.c-quick-pick-card__input {
    -ms-flex: 1;
    flex: 1;
    margin-right: 4px
}

.c-quick-pick-card__input:last-of-type {
    margin-right: 0 !important
}

.c-quick-pick-card__instruction {
    display: block;
    font-size: 16px;
    font-size: .8888889rem;
    font-weight: 500;
...
.c-quick-pick-card__lines {
    margin-left: 0
}

.c-quick-pick-card__line {
    -ms-flex-align: center;
    -ms-flex-pack: justify;
    align-items: center;
    border-bottom: 1px solid #dfdee8;
...
.c-quick-pick-card__line:last-child {
    border-bottom: none
}

.c-quick-pick-card__line-label {
    font-size: 16px;
    font-size: .8888889rem;
    line-height: 24px
}
...
.c-result--lg .c-result__abbr,
.c-result--lg .c-result__multiplier {
    font-size: 16px;
    font-size: .8888889rem;
    font-weight: 500;
    line-height: 1.5
...
.c-result--long .c-result__item {
    margin-bottom: 8px
}

.c-result--long .c-result__item.c-ball--sm,
.c-result--long .c-result__item.c-playing-card--sm {
    margin-bottom: 4px
}

.c-result--long .c-result__multiplier {
    bottom: 8px
}
...
.c-result--has-extra-custom {
    padding-bottom: 32px
}

.c-result__extra-custom {
    bottom: 6px;
    color: #0a0827;
    display: block;
    font-size: 16px;
...
.c-playing-card {
    ...
    background-image: linear-gradient(180deg, #f4f4f7b3, #dfdee8b3);
    border-radius: 8px;
    box-shadow: inset 0 0 0 1px #aeadb5;
    display: -ms-flexbox;
    display: flex;
    -ms-flex-direction: column;
    flex-direction: column;
...
.c-result-card--squeeze .c-result-card__result-row {
    -ms-flex-align: start;
    align-items: flex-start;
    border: none;
    margin-left: 0;
...
.c-result-card__game-details .c-result-card__title {
    color: #0a0827;
    display: block;
    font-size: 24px;
    font-size: 1.3333333rem;
...
.c-result-card__game-details .c-result-card__sub-title {
    color: #0a0827cc;
    display: block;
    font-size: 18px;
    font-size: 1rem;
...
.c-result-card__result-row .c-result-card__result-label {
    margin-bottom: 8px
}

.c-result-card__result-row .c-result-card__result-label+.c-result-card__result-list {
    padding-top: 0
}

.c-result-card__result-list {
    -ms-flex-align: baseline;
    -ms-flex-pack: center;
    align-items: baseline;
    display: -ms-inline-flexbox;
...
.c-result-card__prize-sub-value {
    display: block;
    font-size: 14px;
    font-size: .7777778rem;
    font-weight: 400;
...
.c-result-card__prize-label:before {
    background-image: url('{{asset("dollar.42d1b55f.svg")}}');
    background-position: 50% 50%;
    background-size: 24px 24px;
    content: "";
...
.c-result-card__next-draw {
    background-color: #2622620d;
    border: 2px solid #0a0827;
    border-bottom-left-radius: 12px;
    border-bottom-right-radius: 12px;
    margin-top: -16px;
    overflow: hidden;
...
.c-result-card__next-draw .c-result-card__next-draw-details,
.c-result-card__next-draw .c-result-card__prize-details {
    -ms-flex-pack: justify;
    display: -ms-flexbox;
    display: flex;
    justify-content: space-between;
...
.c-result-card__next-draw .c-result-card__next-draw-details .c-result-card__sub-title {
    font-size: 16px;
    font-size: .8888889rem;
    font-weight: 700;
    line-height: 1.5
...
.c-result-card__next-draw .c-result-card__next-draw-details .c-result-card__title {
    font-size: 14px;
    font-size: .7777778rem;
    font-weight: 500;
    line-height: 1.7142857
...
.c-result-card__next-draw:after {
...
@media (min-width:73.125em) {
  ...
  .c-result-card--minimal .c-result-card__header {
      border-bottom-left-radius: 12px
  }
  ...
  .c-result-card--minimal.c-result-card--has-prizes .c-result-card__result {
      -ms-flex: auto;
      flex: auto;
      padding-right: 0;
      width: auto
  ...
  .c-result-card--minimal.c-result-card--has-prizes .c-result-card__prize {
      -ms-flex-item-align: center;
      align-self: center;
      border-radius: 0;
      padding-right: 0;
  ...
  .c-result-card--squeeze.c-result-card--themed {
      background-color: currentColor;
      background-image: linear-gradient(180deg, #ffffffe6 0, #fff 68px)
  }
  ...
  .c-result-card--long-name .c-result-card__prize {
      width: 36%;
      width: 280px
  }

  .c-result-card--long-name .c-result-card__action {
      width: 39%;
      width: 296px
  }
  ...
  .c-result-card__result-row .c-result-card__result-meta {
      -ms-flex-item-align: start;
      align-self: flex-start;
      margin-bottom: 0;
      margin-top: 16px
  ...
  .c-result-card__result-row .c-result-card__result-meta+.c-result-card__result-list {
      margin-left: auto;
      margin-right: 0;
      padding-top: 0
  }
  ...
  .c-result-card__next-draw .c-result-card__prize-value {
      margin-left: auto
  }

  .c-result-card__next-draw .c-result-card__prize-label {
      -ms-flex-item-align: end;
      align-self: flex-end
  }

  .c-result-card--featured .c-result-card__header {
      -ms-flex-pack: justify;
      -ms-flex-line-pack: center;
      align-content: center;
      display: -ms-flexbox;
  ...
  .c-result-card--featured .c-result-card__title {
      font-size: 28px;
      font-size: 1.5555556rem;
      line-height: 1.1428571
  }

  .c-result-card--featured .c-result-card__action,
  .c-result-card--featured .c-result-card__prize {
      border-radius: 0
  }
  ...
  .c-result-card--featured .c-result-card__media {
      background-color: initial;
      border: 0;
      border-radius: 0;
      height: 128px;
  ...
  .c-result-card--featured .c-result-card__next-draw {
      -ms-flex-line-pack: justify;
      align-content: space-between;
      border-bottom-left-radius: 12px;
      border-left: 1px solid #0a0827;
      border-top: 0;
      border-top-left-radius: 0;
      border-top-right-radius: 0;
      display: -ms-flexbox;
  ...
  .c-result-card--featured .c-result-card__next-draw .c-result-card__next-draw-details {
      -ms-flex-pack: start;
      -ms-flex-preferred-size: 50%;
      flex-basis: 50%;
      justify-content: flex-start;
  ...
  .c-result-card--featured .c-result-card__next-draw .c-result-card__prize-details {
      -ms-flex-preferred-size: 50%;
      border-top: 0;
      flex-basis: 50%;
      padding: 0
  ...
  .c-result-card--featured .c-result-card__cta {
      -ms-flex: 1;
      flex: 1;
      margin-bottom: 0;
      margin-top: 16px;
...
.c-carousel__item>.c-mini-result-card {
    width: 272px
}
...
.c-mini-result-card__header {
    -ms-flex-align: start;
    align-items: flex-start;
    min-height: 64px
}

.c-mini-result-card__result {
    margin: auto 0
}

.c-mini-result-card__result-row {
    -ms-flex-align: center;
    -ms-flex-pack: justify;
    align-items: center;
    display: -ms-flexbox;
...
.c-mini-result-card__result-row+.c-mini-result-card__result-row {
    box-shadow: inset 0 1px 0 0 #0a08270d
}

.c-mini-next-draw-card {
    background-color: #fff;
    background-image: url(build/images/backgrounds/balls-default.179760b0.svg);
    border: 1px solid #dfdee8;
    border-radius: 8px;
...
.c-tool__section-secondary-title .c-info-button,
.c-tool__section-title .c-info-button {
    display: -ms-inline-flexbox;
    display: inline-flex
}
...
@media (max-width:47.99em) {
  ...
  .c-tool .c-ball--xs,
  .c-tool .c-ball--xs .c-ball__label {
      font-size: 10px;
...
.c-export-menu__list-button img,
.c-export-menu__list-button svg {
    margin-right: 12px
}
...
.c-date-field__next-button.is-disabled,
.c-date-field__prev-button.is-disabled {
    cursor: auto;
    opacity: .25
}

.c-date-field--has-top-label .c-date-field__next-button,
.c-date-field--has-top-label .c-date-field__prev-button {
    top: calc(50% - 14px)
}
...
.c-date-field__picker .rdp-button:active:not([disabled]),
.c-date-field__picker .rdp-button:focus:not([disabled]) {
    background-color: #f4f4f7;
    border: none
}
...
.c-date-range-field__picker .rdp-button:active:not(.rdp-day_selected),
.c-date-range-field__picker .rdp-button:focus:not(.rdp-day_selected) {
    background-color: #fff;
...
.c-date-range-field__picker .rdp-nav_button:active:not([disabled]),
.c-date-range-field__picker .rdp-nav_button:focus:not([disabled]) {
    background-color: #f4f4f7;
    border: none
}
...
.c-number-field__input::-webkit-inner-spin-button,
.c-number-field__input::-webkit-outer-spin-button {
    -webkit-appearance: none;
    appearance: none;
    margin: 0
}
...
.c-selector-table__controls,
.c-selector-table__toggles {
    -ms-flex-align: center;
    align-items: center;
    background-color: #0a0827;
...
.c-selector-table--no-radius .c-selector-table__controls,
.c-selector-table--no-radius .c-selector-table__toggles {
    border-top-left-radius: 0;
    border-top-right-radius: 0;
    padding-left: 0;
    padding-right: 0
...
.c-selector-table__controls .c-carousel,
.c-selector-table__toggles .c-carousel {
    width: auto
}

.c-selector-table--no-radius .c-selector-table__controls .c-carousel__item:first-child,
.c-selector-table--no-radius .c-selector-table__toggles .c-carousel__item:first-child {
    padding-left: 16px
}

.c-selector-table--no-radius .c-selector-table__controls .c-radio-group__legend+.c-carousel>.c-carousel__item:first-child,
.c-selector-table--no-radius .c-selector-table__toggles .c-radio-group__legend+.c-carousel>.c-carousel__item:first-child {
    padding-left: 0
}

.c-selector-table__controls .c-carousel__item:last-child,
.c-selector-table__toggles .c-carousel__item:last-child {
    padding-right: 16px !important
}

.c-selector-table__controls .c-radio-group__legend,
.c-selector-table__toggles .c-radio-group__legend {
    color: #0a0827cc;
    color: #fff;
    font-size: 16px;
    font-size: .8888889rem;
...
.c-selector-table--no-radius .c-selector-table__controls .c-radio-group__legend,
.c-selector-table--no-radius .c-selector-table__toggles .c-radio-group__legend {
    margin-left: 16px
}

.c-selector-table__controls .c-radio-field,
.c-selector-table__toggles .c-radio-field {
    background-color: #413e5b;
    box-shadow: none;
    color: #fff;
    margin-bottom: 0 !important;
...
.c-selector-table__controls .c-radio-field.is-checked,
.c-selector-table__toggles .c-radio-field.is-checked {
    background-color: #fff;
    color: #0a0827
}
...
.c-selector-table__table thead,
.c-selector-table__table thead th {
    border-top: 0
}

.c-selector-table__table thead tr:first-of-type th:first-child,
.c-selector-table__table thead tr:first-of-type th:last-child {
    border-radius: 0
}
...
@media (min-width:48em) {
  ...
  .c-selector-table--flush .c-selector-table__controls,
  .c-selector-table--flush .c-selector-table__table :last-child>:last-child>td:first-child,
  .c-selector-table--flush .c-selector-table__table :last-child>:last-child>td:last-child {
      border-radius: 0
  }
}
...
.c-carousel-controls.is-at-end:not(.c-carousel-controls--disabled):after,
.c-carousel-controls.is-at-start:not(.c-carousel-controls--disabled):before {
    content: none
}
...
.c-mini-quick-picks__link:focus,
.c-mini-quick-picks__link:hover {
    box-shadow: none
}
...
@media (min-width:73.125em) {
    ...
    .c-prize-sheet .c-prize-sheet__btn,
    .c-prize-sheet .c-prize-sheet__header,
    .c-prize-sheet .c-prize-sheet__result {
      margin: 0 32px
  }
  ...
  .c-prize-sheet .c-table td:first-child,
  .c-prize-sheet .c-table th:first-child {
      padding-left: 32px
  }

  .c-prize-sheet .c-table td:last-child,
  .c-prize-sheet .c-table th:last-child {
      padding-right: 32px
  }
...
.c-homepage-jackpots-chart-card__stats-date,
...
.c-homepage-lost-for-numbers-card__line-copy span,
.c-homepage-lost-for-numbers-card__line-copy--hidden {
    display: none
}
...
.c-meter--tool-color-1 .c-meter__meter-bar,
.c-meter__meter-bar {
...
.c-meter--error .c-meter__meter-bar,
.c-meter--tool-color-24 .c-meter__meter-bar {
    background-image: linear-gradient(90deg, #be1e2d80, #be1e2d)
}
...
.c-meter--tool-color-1 .c-meter__meter::-moz-meter-bar,
.c-meter__meter::-moz-meter-bar {
    background-image: linear-gradient(90deg, #ff9e0080, #ff9e00)
}
...
.c-meter--error .c-meter__meter::-moz-meter-bar,
.c-meter--tool-color-24 .c-meter__meter::-moz-meter-bar {
    background-image: linear-gradient(90deg, #be1e2d80, #be1e2d)
}
...
.c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter__meter::-webkit-meter-optimum-value,
.c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #ff9e0080, #ff9e00);
    display: inline-block;
    height: 100%;
...
.c-meter--tool-color-1 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-1 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-1 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #ff9e0080, #ff9e00)
}

.c-meter--tool-color-2 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-2 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-2 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #326eb180, #326eb1)
}

.c-meter--tool-color-3 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-3 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-3 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #00887480, #008874)
}

.c-meter--tool-color-4 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-4 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-4 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #be1e2d80, #be1e2d)
}

.c-meter--tool-color-5 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-5 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-5 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #b63dcd80, #b63dcd)
}

.c-meter--tool-color-6 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-6 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-6 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #a1cf6b80, #a1cf6b)
}

.c-meter--tool-color-7 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-7 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-7 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #cf517a80, #cf517a)
}

.c-meter--tool-color-8 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-8 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-8 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #e1d04a80, #e1d04a)
}

.c-meter--tool-color-9 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-9 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-9 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #e46d4680, #e46d46)
}

.c-meter--tool-color-10 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-10 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-10 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #33adb680, #33adb6)
}

.c-meter--tool-color-11 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-11 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-11 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #ff9e0080, #ff9e00)
}

.c-meter--tool-color-12 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-12 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-12 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #326eb180, #326eb1)
}

.c-meter--tool-color-13 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-13 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-13 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #00887480, #008874)
}

.c-meter--tool-color-14 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-14 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-14 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #be1e2d80, #be1e2d)
}

.c-meter--tool-color-15 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-15 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-15 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #b63dcd80, #b63dcd)
}

.c-meter--tool-color-16 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-16 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-16 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #a1cf6b80, #a1cf6b)
}

.c-meter--tool-color-17 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-17 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-17 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #cf517a80, #cf517a)
}

.c-meter--tool-color-18 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-18 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-18 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #e1d04a80, #e1d04a)
}

.c-meter--tool-color-19 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-19 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-19 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #e46d4680, #e46d46)
}

.c-meter--tool-color-20 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-20 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-20 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #33adb680, #33adb6)
}

.c-meter--tool-color-21 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-21 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-21 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #ff9e0080, #ff9e00)
}

.c-meter--tool-color-22 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-22 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-22 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #326eb180, #326eb1)
}

.c-meter--tool-color-23 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-23 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-23 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #00887480, #008874)
}

.c-meter--error .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--error .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--error .c-meter__meter::-webkit-meter-suboptimum-value,
.c-meter--tool-color-24 .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--tool-color-24 .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--tool-color-24 .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #be1e2d80, #be1e2d)
}

.c-meter--success .c-meter__meter::-webkit-meter-even-less-good-value,
.c-meter--success .c-meter__meter::-webkit-meter-optimum-value,
.c-meter--success .c-meter__meter::-webkit-meter-suboptimum-value {
    background-image: linear-gradient(90deg, #00887480, #008874)
}
...
.c-number-checker-result-card .c-ball.c-ball--disabled,
.c-number-checker-result-card .c-ball.c-ball--irrelevant {
    opacity: .5
}
...
.c-number-checker-result-card__claim-label,
.c-number-checker-result-card__prize-label {
    -ms-flex-align: center;
    align-items: center;
    display: -ms-flexbox;
    display: flex;
...
.c-number-checker-result-card__claim-label-icon,
.c-number-checker-result-card__prize-label-icon {
    height: 24px;
    margin-right: 8px;
    width: 24px
}

.c-number-checker-result-card__claim-text,
.c-number-checker-result-card__prize-text {
    font-size: 21px;
    font-size: 1.1666667rem;
    font-weight: 700;
    line-height: 26px
...
.c-details-table dd:first-child,
.c-details-table dd:nth-child(2),
.c-details-table dt:first-child,
.c-details-table dt:nth-child(2) {
    border-top: 1px solid #dfdee8
}
...
.c-details-table--zebra dd:nth-child(4n+4),
.c-details-table--zebra dt:nth-child(4n+3) {
    background-color: #f4f4f740
}
...
@media (min-width:73.125em) {
    ...
    .c-details-table dd:nth-child(odd),
    .c-details-table dt:nth-child(odd) {
      border-left: 1px solid #dfdee8
  }

  .c-details-table dd:nth-child(2n),
  .c-details-table dt:nth-child(2n) {
      border-right: 1px solid #dfdee8
  }
  ...
  .c-details-table dd:nth-last-child(2),
  .c-details-table dt:nth-last-child(2) {
      border-bottom-left-radius: 8px
  }

  .c-details-table dd:last-child,
  .c-details-table dt:last-child {
      border-bottom-right-radius: 8px
  }
}
...
.c-daily-games-table td:first-child,
.c-daily-games-table th:first-child {
    min-width: 120px
}
...
.c-daily-games-table td:not(:first-child),
.c-daily-games-table th:not(:first-child) {
    text-align: center
}
...
.c-quick-picks-card .c-ball,
.c-quick-picks-card .c-ball__label {
    -ms-flex-positive: 0;
    -ms-flex-negative: 0;
...
@media (min-width:48em) {
    ...
    .c-quick-picks-card--gamepage .c-quick-picks-card .c-ball,
    .c-quick-picks-card--gamepage .c-quick-picks-card .c-ball__label {
      font-size: 28px;
      font-size: 1.5555556rem;
      line-height: 24px;
      margin-right: 8px
...
@media (min-width:73.125em) {
    ...
    .c-quick-picks-card__line--long .c-ball,
    .c-quick-picks-card__line--long .c-ball__label {
      -ms-flex-preferred-size: 36px;
      flex-basis: 36px;
      font-size: 18px;
      font-size: 1rem;
...
.c-quick-picks-card .c-copy-to-clipboard,
...
.c-quick-picks-card__single-buy,
.c-quick-picks-card__single-copy {
    -webkit-user-select: none;
    -ms-user-select: none;
    user-select: none
}
...
.c-live-results-table td:last-child,
.c-live-results-table th:last-child {
    border-radius: 0 !important;
    text-align: right
}
...
.c-live-results-table .c-table :last-child>:last-child>td:first-child,
.c-live-results-table .c-table :last-child>:last-child>td:last-child {
    border-radius: 0
}
...
@media (max-width:47.99em) {
    ...
    .c-live-results-table__paused-message td:nth-child(2),
    .c-live-results-table__paused-message td:nth-child(3) {
      display: none
  }
}
...
@media (max-width:47.99em) {
    ...
    .c-live-results-table__separator td:nth-child(2),
    .c-live-results-table__separator td:nth-child(3) {
      display: none
  }
}
...
.c-live-results-table__in-progress-col .c-live-results-table__sub,
.c-live-results-table__not-in-progress-col .c-live-results-table__sub,
.c-live-results-table__result-col .c-live-results-table__sub {
    color: #0a0827cc;
    display: block;
    font-size: 14px;
    font-size: .7777778rem;
...
.c-live-results-table__delayed,
.c-live-results-table__not-in-progress {
    background: #dfdee8;
    border-radius: 4px;
    display: inline-block;
    font-weight: 900;
...
.c-live-results-table .c-table tbody tr th:first-child,
.c-live-results-table .c-table tr td:first-child {
    border-left: 0
}

.c-live-results-table .c-table tbody tr th:last-child,
.c-live-results-table .c-table tr td:last-child {
    border-right: 0
}

@media (max-width:47.99em) {

    .c-live-results-table .c-live-results-table__in-progress-body tr td:nth-child(3),
    .c-live-results-table .c-live-results-table__not-in-progress-body tr td:nth-child(3),
    .c-live-results-table .c-live-results-table__result-body tr td:nth-child(3),
    .c-live-results-table .c-live-results-table__upcoming-body tr:not(.c-live-results-table__separator) td:nth-child(2),
    .c-live-results-table .c-table tr td:nth-child(4),
    .c-live-results-table .c-table tr th:nth-child(3),
    .c-live-results-table .c-table tr th:nth-child(4) {
      display: none
  }
}
...
.c-password-field__show-button:focus,
.c-password-field__show-button:hover {
    color: #0a0827
}
...
.c-delete-account-form,
.c-reset-password-request-form,
.c-reset-password-reset-form {
    border-bottom: 1px solid #dfdee8;
    margin-bottom: 16px;
    overflow: visible
}
...
.c-dob-field .c-number-field__input-container.c-input,
.c-dob-field .c-text-field__input-container.c-input {
    background: none;
    box-shadow: none;
    padding: 0
}
...
.c-user-account-menu__list-button img,
.c-user-account-menu__list-button svg {
    margin-right: 12px
}
...
.c-expanding-menu__list-button img,
.c-expanding-menu__list-button svg {
    margin-right: 12px
}
...
.c-number-checker__result-actions .c-number-checker__filter-toggle,
.c-number-checker__result-actions .c-number-checker__sort-field {
    cursor: pointer;
    -ms-flex: 1;
    flex: 1;
    margin-right: 8px
...
.c-number-checker__result-item-header td,
.c-number-checker__result-item-header th {
    display: block;
    padding: 0;
    text-align: center
}
...
.c-hot-cold__distribution-table td:first-child,
.c-hot-cold__distribution-table th:first-child {
    border-left: 0 !important;
    padding-left: 32px
}

.c-hot-cold__distribution-table td:last-child,
.c-hot-cold__distribution-table th:last-child {
...
@media (max-width:47.99em) {
  ...
  .c-even-odd .c-ball--xs,
  .c-even-odd .c-ball--xs .c-ball__label {
      font-size: 10px;
      font-size: .5555556rem;
      height: 20px;
      line-height: 1.2;
...
@media (max-width:47.99em) {
  ...
  .c-high-low .c-ball--xs,
  .c-high-low .c-ball--xs .c-ball__label {
      font-size: 10px;
      font-size: .5555556rem;
      height: 20px;
      line-height: 1.2;
...
.c-text-field__input-container .st-default-search-input,
...
.st-ui-pagination-link.st-ui-pagination-number-link {
    text-decoration: none
}
...
@media print {
  ...
  .c-breadcrumbs,
  .c-copy-to-clipboard,
  .c-daily-games-table .c-dropdown,
  .c-daily-games-table__highlight,
  .c-export-menu,
  .c-filter-bar,
  .c-footer-navigation,
  ...
  .c-pagination__counter,
  .c-pagination__end,
  .c-pagination__load-more-button,
  .c-prize-sheet,
  .c-region-menu,
  .c-result-card__prize-btn,
  .c-results-table__item-header,
  .c-tool-list,
  .c-tool__breadcrumb,
  .c-tool__title,
...
<style>
  @media only screen and (max-width: 360px) {
    .c-prize-sheet__result-row .c-result__item {
      margin-right: 2px;
  }
}

@media only screen and (max-width: 1169px) {
    .o-lusa-col__content h2:first-of-type {
      font-size: 24px;
      font-size: 1.3333333rem;
      font-weight: 700;
      line-height: 1.1666667;
...
@media only screen and (max-width: 1169px) {
    body>footer>div.o-container.o-container--sm>div>div.o-layout__col.o-layout__col--auto.o-layout__col--4\@lg {
      width: 100%;
  }
...
<style>
  @media only screen and (max-width: 1169px) {
    .c-mini-result-card__result-row .c-result-card__result-list {
      margin-left: 0;
  }
}
</style>
...
<body>
    <div class="o-sticky-header">
      <header id="js-global-header" class="c-global-header " role="banner">
        <div class="c-global-header__container">

            <h3> INTERNATIAL LOTTERY </h3>

            <div class="c-global-header__user-actions"></div>
            <nav id="js-global-nav" class="c-global-nav c-global-header__nav" aria-hidden="true">
                <div class="c-global-nav__user-block"></div>
                <ul class="c-global-nav__menu">
                  <li class="c-global-nav__item">
                    <a href="#" class="c-global-nav__link" title="Home"> Home </a>
                </li>
                <li class="c-global-nav__item">
                    <a href="#" class="c-global-nav__link" title="Powerball">Flag1</a>
                </li><li class="c-global-nav__item">
                    <a href="#" class="c-global-nav__link" title="Powerball">Flag2</a>
                </li><li class="c-global-nav__item">
                    <a href="#" class="c-global-nav__link" title="Powerball">Flag3</a>
                </li><li class="c-global-nav__item">
                    <a href="#" class="c-global-nav__link" title="Powerball">Flag4</a>
                </li><li class="c-global-nav__item">
                    <a href="#" class="c-global-nav__link" title="Powerball">Join</a>
                </li><li class="c-global-nav__item">
                    <a href="#" class="c-global-nav__link" title="Powerball">Login</a>
                </li>
...
<div class="alert alert-success" style="margin: 0px 0px 0px 492px;background: lightgreen;padding: 12px;
    width: 25% !important;"></div>
...
<br>
  <div class="o-container o-container--sm">
    <div class="o-layout">
      <div class="o-layout__col o-layout__col--12 o-layout__col--6@md" style="margin: 0px 280px;">

        <article class="c-result-card c-result-card--featured c-result-card--themed" style="color: rgba(0,6,97,1);">

          <header class="c-result-card__header c-result-card__header--has-sub-title ">
            <table width="100%"> 
                <tr style="width:50%;font-size:16px">
                    <td>
                        <label>Time</label>
                     </td>
                    <td>
    ...
    display: inline-block;
      ...
      <div class="c-result-card__result c-result-card__result--has-extra">
        <table>
            <tr>
                <td>
                    <span style="margin: 0px 60px;"> A : JACKPOT</span>
                    <div class="c-result-card__result-row">                      
                    <table>
                        <tr> 
                            <td><input type="text" class="text-box" name="a1" maxlength="2"></td>
                            <td><input type="text" class="text-box" name="a2" maxlength="2"></td>
                            <td><input type="text" class="text-box-long" name="a3" maxlength="3"></td>
                            <td><input type="text" class="text-box-long" name="a4" maxlength="3"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
            ...
            <td>
              <span style="margin: 0px 72px;"> B : JACKPOT</span>
              <div class="c-result-card__result-row">
                  <table>
                        <tr> 
                            <td><input type="text" class="text-box" name="b1" maxlength="2"></td>
                            <td><input type="text" class="text-box" name="b2" maxlength="2"></td>
                            <td><input type="text" class="text-box-long" name="b3" maxlength="3"></td>
                            <td><input type="text" class="text-box-long" name="b4" maxlength="3"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
        ...
        <tr>
                <td>
                    <span style="margin: 0px 60px;"> C: JACKPOT</span>
                    <div class="c-result-card__result-row">                      
                    <table>
                        <tr> 
                            <td><input type="text" class="text-box" name="c1" maxlength="2"></td>
                            <td><input type="text" class="text-box" name="c2" maxlength="2"></td>
                            <td><input type="text" class="text-box-long" name="c3" maxlength="3"></td>
                            <td><input type="text" class="text-box-long" name="c4" maxlength="3"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
            ...
            <td>
              <span style="margin: 0px 72px;"> D : JACKPOT</span>
              <div class="c-result-card__result-row">
                  <table>
                        <tr> 
                            <td><input type="text" class="text-box" name="d1" maxlength="2"></td>
                            <td><input type="text" class="text-box" name="d2" maxlength="2"></td>
                            <td><input type="text" class="text-box-long" name="d3" maxlength="3"></td>
                            <td><input type="text" class="text-box-long" name="d4" maxlength="3"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
...
<div class="c-result-card__next-draw">
   <!-- <div class="c-result-card__next-draw-details">
      <span class="c-result-card__sub-title c-result-card__prize-label" style="margin: 0px 11px 7px;">2 Digits Lucky Draw / 1 X 50 </span>
      <span class="c-result-card__sub-title c-result-card__prize-label"> 3 Digits Lucky Draw / 1 X 400 </span>
  </div>
  <dl class="c-result-card__prize-details">
      <dt class="c-result-card__prize-label"> Est. Jackpot <b>$ 291 Million</b></dt>
  </dl>-->
...
<div class="c-footer-navigation u-flow-10-to-14 c-footer-navigation--themed">
    <section>
      <div class="o-container o-container--sm">
        <h2 align="center">World Wide Players</h2>
...
<li class="o-layout__col o-layout__col--12 o-layout__col--6@md o-layout__col--3@lg">
    <div class="c-global-footer__link-block">
      <a href="search/index.html" class="c-global-footer__link-block-link" title="Search Internatial Lottery">Search</a>
      <span class="c-global-footer__link-block-desc">Search Internatial Lottery</span>
  </div>
</li>
<li class="o-layout__col o-layout__col--12 o-layout__col--6@md o-layout__col--3@lg">
    <div class="c-global-footer__link-block">
...
<ul class="c-global-footer__link-bar c-global-footer__link-bar--social">
  <li class="c-global-footer__link-bar-item c-global-footer__link-bar-item--social-icon">
    <a href="https://www.facebook.com/" target="_blank" title="Internatial Lottery's Facebook" rel="noopener noreferrer">
      <span class="u-hidden-visually">Internatial Lottery's Facebook</span>
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
        <g>
          <path fill="#FFFFFF" d="M64,32.2C64,14.41,49.67,0,32,0S0,14.41,0,32.2C0,48.27,11.7,61.58,27,64V41.5h-8.12V32.2H27V25.1
          ...
          C52.3,61.58,64,48.27,64,32.2z" />
      </g>
  </svg>
</a>
</li>
<li class="c-global-footer__link-bar-item c-global-footer__link-bar-item--social-icon">
    <a href="https://www.instagram.com/" target="_blank" title="Internatial Lottery's Instagram" rel="noopener noreferrer">
      <span class="u-hidden-visually">Internatial Lottery's Instagram</span>
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
        <g>
          <path fill="#FFFFFF" d="M32,5.77c8.54,0,9.56,0.03,12.93,0.19c3.12,0.14,4.81,0.66,5.94,1.1c1.49,0.58,2.56,1.27,3.68,2.39
          ...
          C41.78,0.04,40.69,0,32,0L32,0z" />
          <path fill="#FFFFFF" d="M32,15.57c-9.08,0-16.43,7.36-16.43,16.43c0,9.08,7.36,16.43,16.43,16.43S48.43,41.08,48.43,32
          C48.43,22.92,41.08,15.57,32,15.57z M32,42.67c-5.89,0-10.67-4.78-10.67-10.67c0-5.89,4.78-10.67,10.67-10.67
          c5.89,0,10.67,4.78,10.67,10.67C42.67,37.89,37.89,42.67,32,42.67z" />
          <circle fill="#FFFFFF" cx="49.08" cy="14.92" r="3.84" />
      </g>
  </svg>
</a>
</li>
<li class="c-global-footer__link-bar-item c-global-footer__link-bar-item--social-icon">
    <a href="https://www.youtube.com/" target="_blank" title="Internatial Lottery's YouTube" rel="noopener noreferrer">
      <span class="u-hidden-visually">Internatial Lottery's YouTube</span>
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
        <path fill="#FFFFFF" d="M61.11,17.49c-0.69-2.6-2.72-4.64-5.3-5.34c-4.68-1.26-23.44-1.26-23.44-1.26s-18.76,0-23.44,1.26
        ...
        S62.36,22.2,61.11,17.49z M26.23,40.95V23.11l15.68,8.92L26.23,40.95z" />
    </svg>
</a>
</li>
</ul>
  ...
  <div class="o-layout__col o-layout__col--auto o-layout__col--8@lg">
    <ul class="c-global-footer__badges">
      <li class="c-global-footer__badges__item">
        <svg x="0px" y="0px" width="48px" height="48px" viewBox="0 0 48 48" enable-background="new 0 0 48 48" xml:space="preserve">
          <path fill="#FFFFFF" fill-opacity="0.2" d="M40.6,16.5c-2.8,0-5.4-1.2-7.2-3.4c-1.8-2.1-2.5-5-2-7.7c-8.7-3.6-18.8-0.5-24,7.4
          s-4.2,18.3,2.5,25s17.1,7.7,25,2.5s11-15.3,7.4-24C41.7,16.5,41.1,16.5,40.6,16.5z" />
          <path fill="#FFFFFF" d="M19.2,32.7V15.3h-2L13,17.2v2.4l2.9-0.7v13.8H19.2z M27.7,33c1.2,0,2.2-0.2,3.2-0.6c1-0.4,1.7-1,2.3-1.8
          ...
          C45.6,15.3,45,15.7,44.4,16z" />
      </svg>
  </li>
  <li class="c-global-footer__badges__item">
    <svg x="0px" y="0px" width="43.7px" height="48px" viewBox="0 0 43.7 48" enable-background="new 0 0 43.7 48" xml:space="preserve">
      <path fill="#0175C2" d="M17.3,21.4c-0.2,0-0.3-0.1-0.5-0.1c-3.7-1.7-6-4.6-6.5-8.7C9.8,8.3,11.2,4.7,14.7,2c1.2-0.9,2.7-1.5,4.2-1.7
      c5-0.9,9.6,0.1,13.6,3.3c2.6,2.1,4.5,4.9,5.4,8c0,0.1,0,0.1,0,0.2c-0.1-0.1-0.1-0.2-0.2-0.3c-2-2.9-4.7-4.9-8.2-5.5
      c-4.1-0.7-7.7,0.4-10.8,3.3c-1.3,1.2-2.2,2.6-2.9,4.2c-1.1,2.7-0.7,5.2,1.2,7.5C17.1,21.2,17.2,21.3,17.3,21.4L17.3,21.4z" />
      <path fill="#01577B" d="M20.2,9.6c0.5-0.4,0.9-0.7,1.4-1C25.9,6,31.3,6.6,34.9,10c1.9,1.7,3.1,3.9,3.6,6.4c0.2,1.6,0.1,3.2-0.4,4.7
      ...
      c-0.6-1-1.3-1.8-2.2-2.4c-1.6-1.2-3.7-1.6-5.7-1.1C20.5,9.5,20.3,9.6,20.2,9.6L20.2,9.6z" />
      <path fill="#01B0F4" d="M29.2,18.1c0.5,3.6-0.4,6.7-2.9,9.4c-1.7,1.8-4,3-6.5,3.4c-2.9,0.4-5.6-0.1-8-1.9C10.2,27.7,8.9,26,8,24.2
      ...
      " />
      <path fill="#01577B" d="M2.4,39.1c0,0.4-0.1,0.8-0.1,1.1c0,1.7,0,3.4,0,5.1c0,0.5,0.1,0.9,0.2,1.4c0,0.3,0.3,0.6,0.6,0.6L4,47.4v0.4
      ...
      c0,0.8-0.1,1.5-0.2,2.3c0,2.2,0,4.4,0,6.6c0,0.2,0,0.4,0,0.6c0,0.2,0,0.3-0.3,0.3L2.4,39.1z" />
      <path fill="#01577B" d="M42.6,37.2c0.1,0.8,0.2,1.6,0.3,2.4l-0.4,0.1c-0.1-0.1-0.1-0.3-0.1-0.4c-0.3-1-1.1-1.7-2.1-1.9
      ...
      c-1.8-0.6-3.2-1.8-3.7-3.7C32.3,41,34,38,36.9,37.2c0.1,0,0.2,0,0.2-0.1c1.6-0.4,3.2-0.4,4.8,0C42.2,37.2,42.4,37.2,42.6,37.2z" />
      <path fill="#01577B" d="M24.1,47.8v-0.4l0.6-0.1c0.4,0,0.6-0.3,0.6-0.7c0-0.2,0.1-0.5,0.1-0.7c0-2.4,0-4.8,0-7.3c0-0.1,0-0.1,0-0.2
      ...
      c0,0.9,0.2,1.1,1.1,1.2l0.4,0v0.4L24.1,47.8z" />
      <path fill="#01577B" d="M22.6,37.3l0.2,2.4l-0.4,0.1c0-0.1-0.1-0.2-0.1-0.3c-0.2-1-1-1.7-2-2c-0.7-0.2-1.4-0.2-2.1-0.1
      ...
      C21.1,37,21.9,37.1,22.6,37.3z" />
      <path fill="#0175C2" d="M17.3,21.4L17.3,21.4L17.3,21.4L17.3,21.4L17.3,21.4z" />
      <path fill="#78797C" d="M20.2,9.6C20.2,9.6,20.2,9.6,20.2,9.6L20.2,9.6z" />
      <polygon fill="#01B0F4" points="10.5,5.2 10.4,5.2 10.5,5.2 " />
  </svg>
</li>
<li class="c-global-footer__badges__item">
    <svg x="0px" y="0px" width="48px" height="48px" viewBox="0 0 48 48" enable-background="new 0 0 48 48" xml:space="preserve">
      <circle fill-rule="evenodd" clip-rule="evenodd" fill="#EDD089" cx="24" cy="24" r="24" />
      <circle fill="#FFDCB3" cx="24" cy="24" r="22.7" />
      <g>
        <path d="M24,6.6C14.7,6.6,7.2,14.4,7.2,24S14.7,41.4,24,41.4S40.8,33.6,40.8,24S33.3,6.6,24,6.6z M28.6,38.8
        ...
        C37.9,27.7,36.7,31.2,34.8,33.8z" />
        <path d="M33.5,15.8c0,0,0,0.1,0,0.1c0,0.2-0.1,0.4-0.2,0.6c0,0.1-0.1,0.2-0.1,0.3c0.7,0.4,1.2,1,1.1,1.6c0,0.2-0.1,0.4-0.2,0.5
        ...
        c0.4-0.1,0.8-0.2,0.8-0.2C26.1,26,26.1,26,26,26.1z" />
        <path d="M16.4,16.1c0,0,0.1,0.1,0.1,0.1l0.1,0.5c0,0.1,0,0.1,0.1,0.2c0,0.1,0.1,0.2,0.2,0.3l0,0c0.1,0.1,0.2,0.1,0.3,0.2
        ...
        c0,0,0-0.1,0-0.1c0,0.6-0.6,1.3-1.4,1.7c-1,0.5-2.1,0.5-2.4-0.2c0,0,0,0,0,0C16.5,15.7,16.5,15.4,16.6,15.1z" />
    </g>
    <g>
        <path d="M5.3,34l3.2-0.6l0.3,0.5l-2.1,2.3l-0.3-0.5l0.5-0.5l-0.6-0.9l-0.7,0.1L5.3,34z M6.7,34.2l0.4,0.7L8,34L6.7,34.2z" />
        <path d="M7.1,36.9l2.4-1.8l1.1,1.4l-0.4,0.3l-0.8-1l-0.7,0.5l0.6,0.8l-0.3,0.3l-0.6-0.8l-1,0.8L7.1,36.9z" />
        <path d="M8.8,39L11,37l1.3,1.3l-0.3,0.3L11,37.6l-0.6,0.6l0.8,0.7l-0.3,0.3l-0.8-0.7l-0.9,0.9L8.8,39z" />
        <path d="M10.7,40.8l2-2.3l0.4,0.3l-2,2.3L10.7,40.8z" />
        <path d="M11.9,41.8l1.7-2.4l0.4,0.3l-1.5,2.1l1.1,0.7l-0.2,0.3L11.9,41.8z" />
        <path d="M14.2,43.2l1.5-2.6l0.5,0.2l-1.5,2.6L14.2,43.2z" />
        <path d="M15.4,43.8l2.1-2.4l0.6,0.2l-0.1,3.1l-0.5-0.2l0-0.7l-1-0.4L15.9,44L15.4,43.8z M16.7,43.1l0.8,0.3l0.1-1.3L16.7,43.1z" />
        <path d="M19.1,45.1l0.6-2.4l-0.8-0.2L19,42l2.1,0.5L21,42.9l-0.8-0.2l-0.6,2.4L19.1,45.1z" />
        <path d="M21.3,45.5l0.3-2.9l1.9,0.2l0,0.4L22.1,43L22,43.8l1.2,0.1l0,0.4L22,44.3l-0.1,0.8l1.4,0.1l0,0.4L21.3,45.5z" />
        <path d="M25.6,45.6l-0.4-2.9l1.1-0.1c0.2,0,0.4,0,0.6,0c0.2,0.1,0.3,0.2,0.4,0.3c0.1,0.1,0.1,0.3,0.2,0.4c0,0.2,0,0.3,0,0.5
        c0,0.1-0.1,0.3-0.3,0.4c-0.1,0.1-0.3,0.2-0.6,0.2l-0.5,0.1l0.1,1.1L25.6,45.6z M25.9,44l0.5-0.1c0.2,0,0.3-0.1,0.4-0.2
        c0.1-0.1,0.1-0.2,0.1-0.3c0-0.1-0.1-0.3-0.2-0.3C26.6,43,26.4,43,26.3,43l-0.5,0.1L25.9,44z" />
        <path d="M28,45.3l0.2-3.1l0.6-0.2l1.8,2.6l-0.5,0.1l-0.4-0.6l-1.1,0.3l0,0.7L28,45.3z M28.6,44l0.8-0.2l-0.7-1.1L28.6,44z" />
        <path d="M31.5,44.3l-1.3-2.7l1-0.4c0.2-0.1,0.4-0.1,0.6-0.1c0.2,0,0.3,0.1,0.4,0.2c0.1,0.1,0.2,0.2,0.3,0.4
        c0.1,0.2,0.1,0.3,0.1,0.5c0,0.2-0.1,0.3-0.3,0.5l1.1,0.9l-0.6,0.2l-1-0.8L31.5,43l0.5,1.1L31.5,44.3z M31.3,42.7l0.5-0.2
        c0.2-0.1,0.3-0.2,0.3-0.3c0-0.1,0-0.2,0-0.4c-0.1-0.1-0.1-0.2-0.3-0.3c-0.1,0-0.3,0-0.4,0l-0.4,0.2L31.3,42.7z" />
        <path d="M34.8,42.6l-1.4-2.1L32.7,41l-0.2-0.4l1.9-1.2l0.2,0.4l-0.7,0.4l1.4,2.1L34.8,42.6z" />
        <path d="M36.6,41.4l-2-2.2l0.4-0.3l2.4,0.7L36,38l0.4-0.3l2,2.2l-0.4,0.3l-2.4-0.7l1.4,1.5L36.6,41.4z" />
        <path d="M39.2,39.1l-2.3-1.9l1.2-1.4l0.3,0.3l-0.9,1l0.6,0.5l0.8-0.9l0.3,0.3l-0.8,0.9l0.7,0.5l0.9-1l0.3,0.3L39.2,39.1z" />
        <path d="M41,36.9l-2.6-1.6l0.6-0.9c0.1-0.2,0.3-0.3,0.4-0.4c0.2-0.1,0.3-0.1,0.5-0.1c0.2,0,0.3,0.1,0.5,0.2
        c0.2,0.1,0.3,0.2,0.4,0.4c0.1,0.2,0.1,0.3,0,0.5l1.4,0.2l-0.3,0.5l-1.3-0.2l-0.2,0.4l1,0.6L41,36.9z M39.9,35.7l0.3-0.4
        c0.1-0.1,0.1-0.3,0.1-0.4c0-0.1-0.1-0.2-0.2-0.3c-0.1-0.1-0.2-0.1-0.4-0.1c-0.1,0-0.2,0.1-0.3,0.3l-0.3,0.4L39.9,35.7z" />
    </g>
    <g>
        <path d="M7.9,14.9l-2.5-1.6l0.3-0.5L7.8,13l-1.1-1.8l0.3-0.5l2.5,1.6l-0.3,0.4l-1.8-1.1l1,1.5l-0.2,0.3l-1.8-0.2l1.8,1.1L7.9,14.9z
        " />
        <path d="M10.1,11.9L7.8,10l0.3-0.4l2.3,1.9L10.1,11.9z" />
        <path d="M11.9,10.1c-0.2,0.2-0.4,0.3-0.7,0.4s-0.5,0-0.7-0.1c-0.2-0.1-0.5-0.3-0.7-0.5C9.6,9.7,9.4,9.5,9.4,9.2
        ...
        c0.1-0.1,0.2-0.3,0.3-0.4c0-0.1,0-0.3-0.1-0.4l0.4-0.4c0.2,0.3,0.2,0.5,0.2,0.8C12.3,9.6,12.1,9.9,11.9,10.1z" />
        <path d="M13.2,8.9l-1.7-2.4L12,6.2l0.7,1l1.1-0.7l-0.7-1l0.4-0.3l1.7,2.4l-0.4,0.3L14,6.9l-1.1,0.7l0.7,1.1L13.2,8.9z" />
        <path d="M15.8,7.3l-1.4-2.6l0.5-0.2l1.4,2.6L15.8,7.3z" />
        <path d="M18.1,6.4c-0.3,0.1-0.5,0.1-0.7,0c-0.2,0-0.4-0.2-0.6-0.3c-0.2-0.2-0.3-0.4-0.4-0.7c-0.1-0.3-0.1-0.6-0.1-0.8
        ...
        C18.5,6.3,18.3,6.3,18.1,6.4z" />
        <path d="M19.8,5.8l0.5-3.1L21,2.6l1.5,2.7l-0.6,0.1l-0.3-0.6L20.5,5l-0.1,0.7L19.8,5.8z M20.6,4.6l0.8-0.1l-0.6-1.1L20.6,4.6z" />
        <path d="M23,5.4l0-2.9l0.5,0l1.3,2.1l0-2.1l0.5,0l0,2.9l-0.5,0l-1.3-2.1l0,2.1H23z" />
        <path d="M27.2,5.6l0.7-2.9l0.5,0.1l-0.6,2.4l1.2,0.3L29,6L27.2,5.6z" />
        <path d="M30.5,6.6c-0.3-0.1-0.5-0.3-0.6-0.5c-0.1-0.2-0.2-0.4-0.3-0.7c0-0.3,0-0.5,0.1-0.8C29.9,4.4,30,4.2,30.3,4
        ...
        c-0.1,0.3-0.1,0.6-0.1,0.8C30.3,5.9,30.5,6.1,30.7,6.2z" />
        <path d="M32.9,7.7l1.3-2.1l-0.7-0.4l0.2-0.4l1.9,1.1l-0.2,0.4l-0.7-0.4L33.3,8L32.9,7.7z" />
        <path d="M35,9.1l1.6-1.9L36,6.6l0.3-0.3l1.7,1.3L37.7,8L37,7.5l-1.6,1.9L35,9.1z" />
        <path d="M36.4,10.3l2.2-2l1.3,1.3l-0.3,0.3L38.7,9l-0.6,0.6l0.8,0.9l-0.3,0.3l-0.8-0.9l-0.6,0.6l0.9,0.9l-0.3,0.3L36.4,10.3z" />
        <path d="M38.1,12.1l2.5-1.7l0.6,0.8c0.1,0.2,0.2,0.3,0.2,0.5c0,0.2,0,0.3-0.1,0.5c-0.1,0.1-0.2,0.3-0.3,0.3
        c-0.2,0.1-0.3,0.2-0.5,0.2c-0.2,0-0.3,0-0.5-0.1l-0.7,1.2L39,13.3l0.7-1.1l-0.3-0.3l-1,0.7L38.1,12.1z M39.7,11.6L40,12
        c0.1,0.1,0.2,0.2,0.3,0.2c0.1,0,0.2,0,0.4-0.1c0.1-0.1,0.2-0.2,0.2-0.3c0-0.1,0-0.2-0.1-0.4l-0.3-0.4L39.7,11.6z" />
        <path d="M39.9,14.8l0.9-0.5l1.3-1.7l0.3,0.5l-0.9,1.2l1.5-0.1l0.3,0.5l-2.2,0.1l-0.9,0.5L39.9,14.8z" />
    </g>
</svg>
</li>
<li class="c-global-footer__badges__item c-global-footer__badges__item--wide">
    <svg x="0px" y="0px" width="142.1px" height="48px" viewBox="0 0 142.1 48" enable-background="new 0 0 142.1 48" xml:space="preserve">
      <g>
        <g>
          <path fill="none" d="M63.8,17.2c-1.4,0-2.8,0-4.2,0c0-1,0-2,0-3c1.2,0,2.3,0,3.5,0c0-0.7,0-1.2,0-1.9c-1.2,0-2.3,0-3.5,0
          c0-0.9,0-1.8,0-2.7c1.4,0,2.8,0,4.1,0c0-0.7,0-1.2,0-1.9c-2.2,0-4.3,0-6.5,0c0,3.8,0,7.6,0,11.3c2.2,0,4.3,0,6.5,0
          C63.8,18.5,63.8,17.9,63.8,17.2z" />
          <path fill="none" d="M33.1,7.5c-2.2,0-4.3,0-6.5,0c0,0,0,0,0,0c-2.2,0-4.3,0-6.5,0c-4.3,0.1-7.4,2.5-8.3,6.4
          ...
          C34.1,7.7,33.5,7.5,33.1,7.5z" />
          <path fill="none" d="M28.8,17.4c-2-0.5-4.2-0.4-6.3-0.5c-0.6,0-1,0.4-1,1c-0.1,1.1-0.2,2.2-0.3,3.3c-0.1,0.8,0.3,1.3,1.2,1.3
          ...
          C33.1,20.3,31.4,18,28.8,17.4z" />
          <path fill="none" d="M40.5,40.3c0.4,0,0.7,0,1,0c0-10.9,0-21.8,0-32.6c-0.4,0-0.7,0-1,0C40.5,18.6,40.5,29.4,40.5,40.3z" />
          <path fill="none" d="M53.8,26.4c0.8,0,1.3,0.5,1.5,1.2c0.1,0.3,0.1,0.7,0.2,1.1c1.1,0,2.1,0,3.3,0c-0.1-0.7-0.2-1.4-0.4-2
          ...
          c-0.7-0.4-1.5-0.8-2.1-1.3c-0.6-0.5-0.6-1.3-0.3-2C52.4,26.5,53,26.3,53.8,26.4z" />
          <path fill="none" d="M51.2,17.3c-0.5-0.4-0.9-1-1.5-1.7c-0.4,0-1.1,0-1.8,0c0,1.9,1,3.2,2.8,3.6c3,0.7,5.1-1.1,4.6-3.9
          ...
          c0.7,0.3,1.4,0.6,2,1c0.6,0.4,0.8,1.4,0.5,2C52.4,17.6,51.7,17.7,51.2,17.3z" />
          <path fill="none" d="M100.5,17.2c-1.4,0-2.8,0-4.1,0c0-1,0-2,0-3c1.2,0,2.3,0,3.5,0c0-0.7,0-1.3,0-2c-1.2,0-2.4,0-3.5,0
          c0-0.9,0-1.7,0-2.6c1.4,0,2.8,0,4.1,0c0-0.7,0-1.3,0-1.9c-2.2,0-4.3,0-6.5,0c0,3.8,0,7.6,0,11.3c2.2,0,4.3,0,6.5,0
          C100.5,18.5,100.5,17.9,100.5,17.2z" />
          <path fill="none" d="M71,45.8c-20,0-39.9,0-59.9,0C31.1,45.8,51,45.8,71,45.8c12.4,0,24.8,0,37.2,0C95.8,45.8,83.4,45.8,71,45.8z" />
          <path fill="none" d="M78.9,19.3c2.2,0,3.5-1.2,3.6-3.2c0.1-2.2,0-4.4,0-6.7c0-0.5,0-1,0-1.6c-0.8,0-1.6,0-2.3,0c0,2.7,0,5.4,0,8.1
          c0,1.1-0.4,1.5-1.4,1.5c-1,0-1.4-0.4-1.4-1.5c0-1.7,0-3.4,0-5.2c0-1,0-1.9,0-2.9c-0.8,0-1.5,0-2.3,0c0,2.9-0.1,5.7,0,8.4
          C75.1,18.3,76.6,19.4,78.9,19.3z" />
          <path fill="none" d="M65,33.1c1.7,0,3.4,0,5,0c0-0.9,0-1.8,0-2.7c-1.7,0-3.4,0-5,0c0-1.3,0-2.6,0-3.9c2,0,4,0,6,0
          c0-0.9,0-1.8,0-2.7c-3.1,0-6.2,0-9.3,0c0,5.5,0,10.9,0,16.3c3.2,0,6.2,0,9.3,0c0-0.9,0-1.8,0-2.7c-2,0-4,0-6,0
          C65,36,65,34.6,65,33.1z" />
          <path fill="none" d="M127.1,16.6c-0.1,0.8,0,1.7,0,2.5c0.9,0,1.6,0,2.5,0c-0.9-3.3,0.6-5.9,1.8-8.7c0.3-0.7,0.6-1.3,0.8-2
          c0.1-0.2,0.1-0.4,0.2-0.7c-0.3,0-0.5,0-0.7,0c-1.7,0-1.7,0-2.3,1.6c-0.4,1.1-0.7,2.2-1.2,3.5c-0.4-1.2-0.7-2.1-1-3.1
          c-0.7-2.1-0.7-2.1-3.2-2c0.8,2,1.6,3.9,2.4,5.7C126.9,14.5,127.1,15.5,127.1,16.6z" />
          <path fill="none" d="M87,15.1c0.9-0.3,1.3,0,1.5,0.8c0.3,0.9,0.7,1.9,1.1,2.8c0.1,0.2,0.3,0.5,0.4,0.5c0.7,0.1,1.5,0,2.3,0
          c-0.7-1.7-1.4-3.2-2-4.7c0.2-0.1,0.4-0.3,0.5-0.4c1.2-1.2,1.3-2.6,0.9-4.1c-0.4-1.4-1.5-2.1-2.8-2.1c-1.4-0.1-2.8,0-4.2,0
          c0,3.8,0,7.6,0,11.3c0.8,0,1.5,0,2.3,0C87,17.8,87,16.4,87,15.1z" />
          <path fill="none" d="M123.1,16.8c0.3-1.6-0.1-2.7-1.4-3.5c1.3-0.8,1.5-2.1,1.2-3.4c-0.3-1.2-1.1-1.9-2.2-2c-1.6-0.1-3.2,0-4.8,0
          c0,3.7,0,7.5,0,11.2c1.6,0,3.2,0.1,4.8,0C121.9,19,122.8,18,123.1,16.8z" />
          <path fill="none" d="M109.4,16.2c0.5-1.8,0.5-3.7,0-5.5c-0.4-1.5-1.4-2.5-2.9-2.8c-1.4-0.2-2.8-0.2-4.2-0.2c0,3.9,0,7.7,0,11.4
          c0.2,0,0.3,0,0.5,0c1,0,2.1,0,3.1-0.1C107.6,19,108.9,17.9,109.4,16.2z" />
          <path fill="none" d="M118,35c0-1.1,0-2.2,0-3.3c-2,0-3.8,0-5.6,0c0,0.8,0,1.6,0,2.5c0.8,0,1.5,0,2.3,0c0,0.9,0,1.7,0,2.5
          ...
          c0.2,2.1,1.3,3.9,3.4,4.6c2.4,0.8,4.7,0.5,6.9-0.8c0.7-0.4,1-1,0.9-1.8C118,36.6,118,35.8,118,35z" />
          <path fill="none" d="M126.9,23.6c-3.1-0.2-5.3,1.6-6,4.8c-0.5,2.5-0.5,5.1,0,7.6c0.6,2.9,2.7,4.5,5.6,4.5c2.9,0,5-1.6,5.6-4.5
          c0.3-1.3,0.3-2.6,0.4-3.6c-0.1-1.4-0.1-2.4-0.2-3.4C132,25.8,129.9,23.8,126.9,23.6z" />
          <path fill="none" d="M76.9,27.8c0.4-1.1,1.2-1.5,2.6-1.4c1,0.1,1.6,0.6,1.8,1.8c0.1,0.4,0.1,0.8,0.1,1.2c1.1,0,2.2,0,3.3,0
          ...
          C76.7,28.3,76.8,28,76.9,27.8z" />
          <path fill="none" d="M73.2,15.4c-0.7,0-1.5,0-2.2,0c0,0.3-0.1,0.6-0.1,0.8c-0.1,0.8-0.6,1.2-1.4,1.2c-0.8,0-1.5-0.2-1.6-1.1
          ...
          C72.3,18.7,73.3,17.3,73.2,15.4z" />
          <path fill="none" d="M86.2,26.6c1.3,0,2.6,0,4,0c0,4.6,0,9.1,0,13.6c1.1,0,2.1,0,3.3,0c0-4.6,0-9.1,0-13.6c1.4,0,2.7,0,4,0
          c0-0.9,0-1.8,0-2.7c-3.8,0-7.5,0-11.3,0C86.2,24.8,86.2,25.7,86.2,26.6z" />
          <path fill="none" d="M100.2,40.2c1.1,0,2.1,0,3.2,0c0-5.5,0-10.9,0-16.3c-1.1,0-2.2,0-3.2,0C100.2,29.4,100.2,34.8,100.2,40.2z" />
          <path fill="#03B374" d="M142.1,11.2c0-1.1-0.2-2.2-0.4-3.2c-1.3-4.8-5.6-7.9-10.8-7.9C109.9,0,89,0,68,0C49.1,0,30.1,0,11.2,0
          ...
          c39.8,0,79.5,0,119.3,0c4.6,0,8.2,2.8,9,7.1c0.1,0.7,0.1,1.4,0.1,2.1c0,8.4-0.1,16.8,0,25.1C140,42,135.7,45.9,130.6,45.9z" />
          <path fill="#FCFDFD" d="M139.9,11.4c0-0.7,0-1.4-0.1-2.1c-0.9-4.3-4.4-7.1-9-7.1c-39.8,0-79.5,0-119.3,0c-5.5,0-9.2,3.7-9.2,9.2
          ...
          c0.1,1,0.1,2.1,0.2,3.4C132.5,33.4,132.5,34.7,132.2,36z" />
      </g>
      <path fill="#26B57D" d="M26.6,7.5c2.2,0,4.3,0,6.5,0c0.4,0,1,0.2,1.1,0.5c0.2,0.3,0,0.9-0.2,1.3c-0.4,0.8-1,1.5-1.5,2.3
      ...
      <path fill="#25B57C" d="M17.7,40.4c-2.3,0-4.6,0-6.9,0c-0.4,0-1-0.2-1.1-0.5c-0.2-0.3,0-0.9,0.2-1.3c0.4-0.8,1-1.5,1.5-2.3
      ...
      C17.7,40.3,17.7,40.3,17.7,40.4z" />
      <path fill="#081F2F" d="M132.6,32.4c-0.1,1-0.1,2.3-0.4,3.6c-0.6,2.9-2.7,4.5-5.6,4.5c-2.9,0-5-1.6-5.6-4.5c-0.6-2.5-0.5-5.1,0-7.6
      ...
      c-0.4-0.9-1.1-1.3-2-1.3c-1.3,0-2.1,0.7-2.4,2.2C124,29.7,124,30.9,123.9,32.1z" />
      <path fill="#092030" d="M118,29c-1,0-2.1,0-3.1,0c0-0.3-0.1-0.5-0.1-0.8c-0.2-1.3-0.8-1.8-1.9-1.9c-1.3-0.1-2.2,0.4-2.5,1.6
      ...
      c-2.1-0.7-3.2-2.5-3.4-4.6c-0.2-2.4-0.3-4.9,0.1-7.3c0.7-4.1,5.4-5.9,8.9-3.6C117.2,25.3,117.9,27,118,29z" />
      <path fill="#092030" d="M48.1,35.1c1.1,0,2.2,0,3.3,0c0,0.3,0.1,0.6,0.1,0.9c0.2,1,0.7,1.5,1.7,1.7c1.1,0.2,1.9-0.1,2.2-0.9
      ...
      c-0.7,2-2.9,3.2-5.5,2.9c-2.7-0.3-4.4-1.9-4.9-4.3C48.1,35.8,48.1,35.5,48.1,35.1z" />
      <path fill="#0A2030" d="M70,33.1c-1.7,0-3.3,0-5,0c0,1.4,0,2.8,0,4.3c2,0,4,0,6,0c0,0.9,0,1.8,0,2.7c-3.1,0-6.2,0-9.3,0
      c0-5.4,0-10.8,0-16.3c3.1,0,6.2,0,9.3,0c0,0.9,0,1.7,0,2.7c-2,0-3.9,0-6,0c0,1.3,0,2.5,0,3.9c1.7,0,3.3,0,5,0
      C70,31.4,70,32.2,70,33.1z" />
      <path fill="#09202F" d="M84.7,29.4c-1.1,0-2.2,0-3.3,0c0-0.4-0.1-0.8-0.1-1.2c-0.2-1.2-0.7-1.7-1.8-1.8c-1.4-0.1-2.1,0.3-2.6,1.4
      ...
      C84,25.5,84.5,27.3,84.7,29.4z" />
      <path fill="#081F2F" d="M93.5,40.2c-1.2,0-2.2,0-3.3,0c0-4.5,0-9,0-13.6c-1.4,0-2.7,0-4,0c0-0.9,0-1.8,0-2.7c3.8,0,7.5,0,11.3,0
      c0,0.9,0,1.7,0,2.7c-1.3,0-2.6,0-4,0C93.5,31.1,93.5,35.6,93.5,40.2z" />
      <path fill="#092030" d="M121.7,13.3c1.3,0.8,1.7,1.9,1.4,3.5c-0.3,1.2-1.1,2.2-2.4,2.3c-1.6,0.1-3.2,0-4.8,0c0-3.7,0-7.5,0-11.2
      ...
      c-0.5-0.8-1.4-0.5-2.3-0.5C118.1,10.6,118.1,11.5,118.1,12.5z" />
      <path fill="#0B2232" d="M84.7,7.8c1.4,0,2.8-0.1,4.2,0c1.4,0.1,2.5,0.7,2.8,2.1c0.4,1.5,0.3,2.9-0.9,4.1c-0.1,0.1-0.3,0.3-0.5,0.4
      ...
      c-0.4-0.8-1.4-0.5-2.3-0.5C87,10.8,87,11.9,87,13.1z" />
      <path fill="#0B2232" d="M102.3,19.1c0-3.8,0-7.5,0-11.4c1.4,0.1,2.8,0,4.2,0.2c1.5,0.2,2.5,1.3,2.9,2.8c0.5,1.8,0.5,3.7,0,5.5
      c-0.4,1.7-1.8,2.7-3.5,2.9c-1,0.1-2.1,0.1-3.1,0.1C102.6,19.2,102.5,19.2,102.3,19.1z M104.6,9.7c0,2.6,0,5.1,0,7.5
      c2,0.1,2.6-0.4,2.7-2.4c0-0.9,0-1.9,0-2.8C107.2,10.1,106.6,9.6,104.6,9.7z" />
      <path fill="#0A2131" d="M103.4,40.2c-1.1,0-2.1,0-3.2,0c0-5.4,0-10.8,0-16.3c1,0,2.1,0,3.2,0C103.4,29.3,103.4,34.7,103.4,40.2z" />
      <path fill="#091F2F" d="M75,7.8c0.8,0,1.5,0,2.3,0c0,1,0,2,0,2.9c0,1.7,0,3.4,0,5.2c0,1.1,0.5,1.5,1.4,1.5c1,0,1.4-0.4,1.4-1.5
      c0-2.7,0-5.3,0-8.1c0.8,0,1.5,0,2.3,0c0,0.5,0,1,0,1.6c0,2.2,0,4.5,0,6.7c-0.1,2-1.4,3.2-3.6,3.2c-2.3,0-3.8-1-3.9-3.1
      C74.9,13.4,75,10.6,75,7.8z" />
      <path fill="#0E2534" d="M57.3,7.8c2.2,0,4.3,0,6.5,0c0,0.6,0,1.2,0,1.9c-1.4,0-2.7,0-4.1,0c0,0.9,0,1.8,0,2.7c1.1,0,2.3,0,3.5,0
      c0,0.7,0,1.2,0,1.9c-1.2,0-2.3,0-3.5,0c0,1,0,1.9,0,3c1.4,0,2.8,0,4.2,0c0,0.7,0,1.3,0,1.9c-2.2,0-4.3,0-6.5,0
      C57.3,15.4,57.3,11.6,57.3,7.8z" />
      <path fill="#0F2635" d="M94,7.8c2.2,0,4.3,0,6.5,0c0,0.6,0,1.2,0,1.9c-1.4,0-2.7,0-4.1,0c0,0.9,0,1.7,0,2.6c1.1,0,2.3,0,3.5,0
      c0,0.7,0,1.3,0,2c-1.2,0-2.3,0-3.5,0c0,1,0,1.9,0,3c1.4,0,2.7,0,4.1,0c0,0.7,0,1.2,0,1.9c-2.1,0-4.3,0-6.5,0
      C94,15.4,94,11.6,94,7.8z" />
      <path fill="#092030" d="M47.9,15.6c0.8,0,1.5,0,1.8,0c0.6,0.7,0.9,1.4,1.5,1.7c0.5,0.3,1.2,0.2,1.6-0.4c0.4-0.6,0.1-1.6-0.5-2
      ...
      c1.2,0.6,2.3,1.2,2.5,2.6c0.5,2.8-1.6,4.6-4.6,3.9C48.9,18.8,47.9,17.5,47.9,15.6z" />
      <path fill="#092030" d="M73.2,11.6c-0.7,0-1.5,0-2.2,0c0-0.3,0-0.5-0.1-0.7c-0.1-0.8-0.5-1.3-1.4-1.3c-0.8,0-1.6,0.2-1.6,1.1
      ...
      C72.1,8,73.2,9.5,73.2,11.6z" />
      <path fill="#0C2333" d="M124,7.8c2.5-0.2,2.5-0.2,3.2,2c0.3,1,0.6,1.9,1,3.1c0.4-1.3,0.8-2.4,1.2-3.5c0.6-1.6,0.6-1.6,2.3-1.6
      ...
      c0.1-1.1-0.2-2.1-0.6-3.1C125.6,11.7,124.8,9.8,124,7.8z" />
      <path fill="#2AB77F" d="M41.5,40.3c-0.4,0-0.7,0-1,0c0-10.9,0-21.7,0-32.6c0.3,0,0.6,0,1,0C41.5,18.5,41.5,29.4,41.5,40.3z" />
      <path fill="#FBFCFC" d="M123.9,32.1c0.1-1.2,0.1-2.4,0.3-3.5c0.2-1.5,1.1-2.2,2.4-2.2c1,0,1.7,0.4,2,1.3c0.2,0.4,0.4,0.9,0.4,1.4
      c0,2.1,0.1,4.3-0.1,6.4c-0.1,1.5-1,2.2-2.3,2.2c-1.3,0-2.2-0.7-2.5-2.2c-0.1-0.3-0.1-0.6-0.1-0.9c0-0.8,0-1.7,0-2.5
      C124,32.1,123.9,32.1,123.9,32.1z" />
      <path fill="#F8F9F9" d="M118.2,17.2c0-1,0-2,0-2.9c2.1-0.2,2.6,0,2.7,1.3C120.9,17,120.4,17.3,118.2,17.2z" />
      <path fill="#F8F9F9" d="M118.1,12.5c0-1,0-1.9,0-2.8c0.8,0,1.8-0.3,2.3,0.5c0.3,0.4,0.3,1.3,0,1.7C120,12.9,119,12.4,118.1,12.5z" />
      <path fill="#F5F6F5" d="M87,13.1c0-1.2,0-2.2,0-3.4c0.8,0,1.8-0.4,2.3,0.5c0.3,0.6,0.3,1.6,0.1,2.2C89,13.5,87.9,12.9,87,13.1z" />
      <path fill="#FAFBFB" d="M104.6,9.7c2-0.1,2.6,0.4,2.7,2.3c0,0.9,0.1,1.9,0,2.8c-0.1,1.9-0.7,2.4-2.7,2.4
      C104.6,14.8,104.6,12.3,104.6,9.7z" />
  </g>
</svg>
</li>
</ul>
...
<div class="o-layout__col o-layout__col--auto o-layout__col--4@lg">
    <div class="c-global-footer__lusa-seal">
      <span class="c-global-footer__lusa-seal-badge">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
          <g>
            <path fill="#F4DF84" d="M29.2,54.1c0,0,0-0.1,0-0.2c-0.1-0.1-0.2-0.2-0.3-0.2c-0.1,0-0.3,0-0.4,0.1c0,0,0,0,0,0c0,0,0,0,0,0
            ...
            C29.2,54.2,29.2,54.2,29.2,54.1z" />
            <g>
              <path fill="#F4DF84" d="M25.3,25.2c0-0.4,0-0.8,0.1-1.2s0.2-0.6,0.4-0.8c0.2-0.2,0.5-0.3,0.9-0.3c0.3,0,0.6,0.1,0.8,0.4
              ...
              c-1.1,0-2,0.2-2.7,0.7c-0.7,0.5-1.2,1-1.5,1.8c-0.3,0.8-0.5,1.6-0.5,2.6V26h3.3V25.2z" />
              <polygon fill="#F4DF84" points="34.9,37.2 38.4,37.2 42.1,22.5 42.1,20.1 34,20.1 34,22.8 38.6,22.8      " />
          </g>
          <path fill="#F4DF84" d="M32,1.1C15,1.1,1.1,15,1.1,32S15,62.8,32,62.8S62.8,49,62.8,32S49,1.1,32,1.1z M8.8,38.4l1.3,2l-2.3-0.9
          ...
          C62,34.2,62,34,62,33.8z" />
          <path fill="#F4DF84" d="M35,56.2l-0.1-1.2c0-0.2,0-0.3-0.1-0.5c0,0,0-0.1,0-0.1c0-0.2-0.1-0.3-0.2-0.4c-0.1-0.1-0.2-0.1-0.4-0.1
          ...
          c0.1,0,0.2-0.1,0.3-0.1c0.1-0.1,0.1-0.2,0.2-0.2L35,56.2L35,56.2L35,56.2z" />
          <path fill="#F4DF84" d="M56.5,17.3l-5.6,2.8l0.7,1.4c0.2,0.5,0.5,0.8,0.8,1s0.5,0.3,0.9,0.3c0.3,0,0.7-0.1,1.1-0.4l2-1
          ...
          C56.4,19.7,56.4,19.8,56.3,19.8z" />
          <path fill="#F4DF84" d="M32,0C14.4,0,0,14.4,0,32s14.4,32,32,32s32-14.3,32-32S49.7,0,32,0z M32,63.4C14.7,63.4,0.6,49.3,0.6,32
          S14.7,0.6,32,0.6S63.4,14.7,63.4,32S49.3,63.4,32,63.4z" />
          <polygon fill="#F4DF84" points="51,15.6 51.7,16.5 52.5,15.9 51.8,15 53,14 53.9,15.1 54.6,14.5 52.8,12.4 48,16.4 49.8,18.5
          50.5,17.9 49.6,16.8     " />
          <path fill="#F4DF84" d="M14.4,15.9c-0.3-0.3-0.7-0.4-1-0.4c-0.3,0-0.7,0-1,0.1l-0.7,0.1c-0.2,0.1-0.4,0.1-0.6,0.1
          ...
          c0.1-0.3,0-0.5-0.1-0.8C14.8,16.3,14.6,16.1,14.4,15.9z" />
          <polygon fill="#F4DF84" points="15.8,9.6 15.1,8.9 12.6,10.9 13.3,11.7 14,11.1 17.3,15.1 18.4,14.2 15,10.2   " />
          <polygon fill="#F4DF84" points="35.4,9.8 36.8,10 37.9,3.9 36.6,3.7   " />
          <polygon fill="#F4DF84" points="11.1,21.9 9.4,21.1 9.9,20.2 9,19.8 8.6,20.8 7.2,20.1 7.8,18.8 6.9,18.4 5.7,21 11.4,23.6
          12.6,21 11.7,20.6   " />
          <path fill="#F4DF84" d="M28.2,7.1C28,7,27.9,6.8,27.7,6.7c-0.2-0.1-0.4-0.1-0.6-0.1c0.2-0.1,0.3-0.2,0.4-0.3
          ...
          C27.2,8.4,27.2,8.7,27.2,8.8z" />
          <path fill="#F4DF84" d="M18.2,6.9l1.8,6l1.1-0.6L20.8,11l0.8-0.4l0.8,1.1l1.1-0.6l-3.9-5L18.2,6.9z M21.1,10l-0.6,0.3L19.7,8
          L21.1,10z" />
          <polygon fill="#F4DF84" points="32.3,3.3 30.9,3.3 30.8,9.5 33.6,9.6 33.6,8.6 32.2,8.6   " />
          <path fill="#F4DF84" d="M42.3,8.4L42,7.7c-0.1-0.2-0.2-0.4-0.2-0.6c0-0.2,0-0.4,0.1-0.6c0-0.1,0.1-0.2,0.2-0.3s0.2-0.1,0.3-0.1
          ...
          c0.2,0.2,0.5,0.4,0.8,0.6c0.3,0.1,0.6,0.2,0.9,0.1s0.5-0.1,0.7-0.3s0.4-0.4,0.5-0.7c0.2-0.4,0.2-0.8,0.2-1.1S42.5,8.7,42.3,8.4z" />
          <path fill="#F4DF84" d="M18,39.9H46c0.3-0.3,0.7-0.5,1-0.9H17C17.3,39.3,17.6,39.5,18,39.9z" />
          <g>
              <path fill="#F4DF84" d="M24.8,41.1C24.8,41.1,24.7,41.1,24.8,41.1l-0.6,2h0l-0.6-1.9c0,0,0-0.1-0.1-0.1h-0.9c-0.1,0-0.1,0-0.1,0.1
              l1.1,3v2c0,0,0,0.1,0.1,0.1h0.9c0,0,0.1,0,0.1-0.1v-2l1.1-3c0,0-0.1-0.1-0.1-0.1H24.8z" />
              <path fill="#F4DF84" d="M26.7,41.1C26.6,41.1,26.6,41.1,26.7,41.1l-0.1,5.1c0,0,0,0.1,0.1,0.1h2.5c0,0,0.1,0,0.1-0.1v-0.8
              c0,0,0-0.1-0.1-0.1h-1.4c0,0,0,0,0,0v-1.2c0,0,0,0,0,0H29c0,0,0.1,0,0.1-0.1v-0.7c0,0,0-0.1-0.1-0.1h-1.2c0,0,0,0,0,0v-1.1
              c0,0,0,0,0,0h1.4c0,0,0.1,0,0.1-0.1v-0.8c0,0,0-0.1-0.1-0.1C29.2,41.1,26.7,41.1,26.7,41.1z" />
              <path fill="#F4DF84" d="M32.2,41.1h-1c0,0-0.1,0-0.1,0.1l-1.2,5c0,0,0,0.1,0.1,0.1h0.9c0.1,0,0.1,0,0.1-0.1l0.2-0.9h1.1l0.2,0.9
              c0,0,0,0.1,0.1,0.1h0.9c0,0,0.1,0,0.1-0.1l-1.2-5C32.3,41.2,32.3,41.1,32.2,41.1z M31.4,44.5l0.4-1.8h0l0.3,1.8H31.4z" />
              <path fill="#F4DF84" d="M40.4,43.2l-0.3-0.1c-0.4-0.2-0.5-0.3-0.5-0.7c0-0.3,0.1-0.5,0.4-0.5s0.4,0.2,0.4,0.6c0,0,0,0.1,0.1,0.1
              ...
              c1.2,0,1.6-0.5,1.6-1.6C41.5,43.9,41.2,43.5,40.4,43.2z" />
              <path fill="#F4DF84" d="M37.5,42.7c0-1.2-0.7-1.6-1.7-1.6h-1.4c0,0-0.1,0-0.1,0.1v5c0,0,0,0.1,0.1,0.1h0.9c0,0,0.1,0,0.1-0.1v-1.9
              ...
              V42c0,0,0,0,0,0h0.2c0.4,0,0.6,0.2,0.6,0.7C36.4,43.2,36.2,43.4,35.8,43.4z" />
          </g>
          <path fill="#F4DF84" d="M32,13.3c-10.3,0-18.7,8.4-18.7,18.7c0,10.3,8.4,18.7,18.7,18.7S50.7,42.3,50.7,32S42.3,13.3,32,13.3z
          M32,50.1C22,50.1,13.9,42,13.9,32S22,13.9,32,13.9S50.1,22,50.1,32S42,50.1,32,50.1z" />
          <polygon fill="#F4DF84" points="49.1,9 47.6,11.1 46.8,10.5 48.3,8.5 47.2,7.7 43.5,12.7 44.6,13.5 46.2,11.3 47,11.9 45.4,14.1
          46.5,14.9 50.2,9.9  " />
      </g>
  </svg>
</span>
<p class="c-global-footer__lusa-seal-text">
    <span class="t-h6">Established in 1995</span>, <br>Internatial Lottery is America's leading lottery resource.
</p>
</div>
</div>
</div>
...
<div class="c-global-footer__small-print">
    <div class="o-container">
      <small>Please note: These results are unofficial. Always check with the official source for lottery numbers in a particular state. Internatial Lottery is an independent lottery results service and is neither endorsed, affiliated nor approved by any state, multi-state lottery operator or organization whatsoever. All trademarks remain the property of their rightful owners and used for informational purposes only. Copyright 1995-2023 Lotto Logic LTD., All Rights Reserved.</small>
      <p class="c-global-footer__updated">Updated: <time datetime="2023-01-14T07:00">Sat, Jan 14, 2023 @ 7:00 AM</time>
      </p>
  </div>
</div>
</footer>
<div class="c-global-overlay-footer">
  <div class="js-notifications" data-props="{&quot;html&quot;:{&quot;classes&quot;:&quot;c-global-overlay-footer__item&quot;}}">
    <div class="c-notifications c-global-overlay-footer__item"></div>
</div>
<div class="js-back-to-top-button" data-props="{&quot;html&quot;:{&quot;classes&quot;:&quot;c-global-overlay-footer__item&quot;}}"></div>
</div>
