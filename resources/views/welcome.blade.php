                            ...
                            <div class="row">
                                <div class="col-md-12 text-center ">
                                    <div class="row text-center">
                                        <div class="col-md-6">
                                        <strong class="jcc-r"><div class="center" id="a1_8">00</div></strong>
                                        </div>
                                            <div class="col-md-6">
                                        <strong class="jcc-l"><div class="center" id="a2_8">000</div></strong>
                                        </div>
                                       </div>
                                    </div>
                                </div>
